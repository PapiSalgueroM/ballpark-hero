...
- 2026-05-29 | B | 3.4 Guess The Nation | Audit only. MAJOR MISMATCH: guess_nation_countries is an OLYMPICS/medals schema but candidates are SOCCER clues. Can't map -> no SQL. Also Spain "4 of last 5 Euros" likely wrong (it is 3). Candidate likely for a different/new game | b7522d9
- 2026-05-29 | B | 3.16 CBB VERIFIED | Anthony fact-checked: 23/24 correct; Michigan corrected to 2 titles (1989, 2026 — post-cutoff). Banner + MANIFEST -> verified/cleared to apply. Anthony applies manually | ff83a93
- 2026-05-29 | infra | daily_completions reconstructed | Live DB had no daily_completions (to_regclass NULL) and repo had no CREATE. Reconstructed from types.ts + app usage into supabase/migrations/20260529000001_daily_completions.sql (idempotent; supersedes 20260330031441's daily_completions policies). Anthony applies manually | (this commit)
