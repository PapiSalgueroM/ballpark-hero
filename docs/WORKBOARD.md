...
and reset behavior remains. The one-line repair passes the unchanged audit,
four new cases and 68 prior NBA/help cases. Six new source controls plus the
migrated old control produce their exact failures; runtime/backend errors
reject. Both exact types, build and all fifteen site checks pass. Phone and
desktop each settle one actual battle and restart cleanly, with zero faults.
Independent review and main image review are clear. Evidence:
docs/nba-disposal-2026-09-08.md. Preview4214, PID23984, index-HQ5kJYFh.js and
ConquestNba-BzJsKAFc.js. Preserve all earlier worktrees/previews and Claude's root.
...
the card. The final territory power ends the game once without a timer
reopening it. The inventory cap, pool, random fallback and formulas remain.
No new player data or upgrade lifetime/stacking change in this round.
Twenty-five new cases, 70 source controls with 133 intended failures,
both exact types, build, all fifteen site checks and 83 prior cases pass.
Phone/desktop each pass seven actual turns and the full reward flow; both
dead-button controls pass. Main visual and independent source review clear.
Evidence: docs/nfl-powers-2026-09-08.md. Preview4210 preserved.
Next free534: reproduced NFL queued upgrade loss on an unrelated turn.
Root belongs to Claude.
...
## Round 531 complete, September 8, 2026

Codex owns NFL Arcade Free Agency action guards and phase-aware controls in
useConquest.ts and ConquestBoard.tsx, plus the pool's unsupported static
...
Nine hook and fourteen panel cases, 47 exact source controls, both exact
types, build and all fifteen site checks pass. Built phone and desktop each
pass eight battles, five neutral claims, two signings and elimination
recovery, plus both dead Change controls. Source and main visual reviews
clear. Evidence: docs/nfl-free-agency-2026-09-08.md. Preview4208 preserved.
...
player clears their queued upgrade. Unsupported current-market blurbs are
removed without changing player identities or game ratings.
Nine hook and ten panel cases, 39 exact source controls, 49 prior cases,
both exact types, build and fifteen site fences pass. Built phone/desktop
walks each settle eight real battles with two signings and elimination
recovery. Both dead-picker controls pass; main visual inspection clear.
Final independent production, controls and bounded-browser review clear.
Evidence: docs/nba-free-agency-2026-09-08.md. Preview4207 remains available.
