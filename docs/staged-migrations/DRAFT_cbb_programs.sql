-- APPLIED 2026-06-14 by Anthony — 24 rows seeded into public.cbb_programs; /guess-cbb-team confirmed working.
-- Unblocks P0-4 (the game was code-fixed but had zero rows).
...
-- Fact-check: 22/24 rows correct as drafted; two wording fixes applied below
--   (Kansas/Naismith, Cincinnati/Robertson); Michigan kept at 2 titles (1989, 2026),
--   the 2026 confirmed by Anthony (post knowledge-cutoff). See docs/audits/cbb_programs_audit.md.
...
('Kansas', ARRAY['Kansas','KU','Jayhawks'], 'Historic', 'Lawrence, Kansas (Midwest)', 'Big 12', 'James Naismith, inventor of basketball, was the first coach here; Bill Self era now', '4 national titles (1952, 1988, 2008, 2022)', 'Jayhawks; home is Allen Fieldhouse', 'easy'),
...
('Cincinnati', ARRAY['Cincinnati','Bearcats','UC'], 'Old guard', 'Cincinnati, Ohio (Midwest)', 'Big 12 (since 2023)', 'Oscar Robertson starred around 1960; won back-to-back titles just after', '2 national titles (1961, 1962)', 'Bearcats', 'hard'),
