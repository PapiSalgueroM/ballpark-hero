...
- S-5 The other career and manager games are "so way behind compared to the soccer ones":
  ...
  truths). Of the five named CM systems (roles, press, talks, market, boards), only PRESS
  remains: press moments for the careers, press and negotiation depth beyond accept/reject
  for the GM games.
...
| Next free round number | **184** (check the folder first, the 3-hourly build task may have taken it) |
