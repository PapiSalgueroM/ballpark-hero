...
- S-5 The other career and manager games are "so way behind compared to the soccer ones":
  ...
  extensions if ever wanted: GM-side press, negotiation depth beyond accept/reject in the
  GM trade engines.
...
| Next free round number | **190** (check the folder first, the 3-hourly build task may have taken it) |
