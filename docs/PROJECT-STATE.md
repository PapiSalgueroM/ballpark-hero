...
1. **person_key backfill** (from Round 224). The stints table's identity is (name, nationality)
   and mononym players collide; person_key exists but covers 9 of 80,586 rows. Backfilling it
   (debut_year and career-shape heuristics can split most collisions) would fix merged careers
   at the root and let Grade the Transfer regain the double-movers Round 224 had to drop.
2. **The Round 224 leads that resolved as KEEP, recorded so nobody re-litigates:** the
   ...
   have.
3. **Mini games, harder criteria** (the owner's standing appetite for more games). The
   measured AU signal is worth weighing here: Australia is the number two country at 3,551
   visits a month and the site has zero Australian sport content.
