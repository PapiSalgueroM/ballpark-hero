...
| Next free round number | **200** (check the folder first, the 3-hourly build task may have taken it) |
...
- **Sponsors in Club Manager.** The last unbuilt line of his epic.
- **National team football inside Club Manager.**
...
- **Sacked-manager unemployed state** with an earned offer feed. The sacked flag exists; the
  state after it does not.
