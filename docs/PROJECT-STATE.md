...
- S-3 More animation everywhere, standing item F from the first review. THIRD PASS DONE,
  ...
  title, banned years muted, every line verbatim from the sport engines). Next candidates:
  the Front Office verdict reveal (same engine, natural Round 187), Soccer Career match
  moments, home page tiles.
...
| Next free round number | **187** (check the folder first, the 3-hourly build task may have taken it) |
