...
- CM-6 **WAVE 3 FIRST PAIR DONE, Round 177: Austria and Greece.** Two leagues from the
  ...
  **WAVE 3 SECOND PAIR DONE, Round 185: Denmark and Switzerland,** by the same recipe (two
  ...
  for the zero-row squads). World is 320 clubs across 19 leagues in 16 nations. Remaining
  wave-3 candidates when their data or memberships firm up: Czechia (still parked on the
  Karviná fallout), Croatia, and Liga MX (blocked on the split-season engine shape, same as
...
| Next free round number | **189** (check the folder first, the 3-hourly build task may have taken it) |
