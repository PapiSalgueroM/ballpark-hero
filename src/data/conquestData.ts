...
export const NFL_TEAMS: NFLTeam[] = [
  ...
  { id: 'BUF', name: 'Bills', city: 'Buffalo', rating: 96, color: '#00338D', roster: [], players: [
    ...
    { name: 'Amari Cooper', position: 'WR', overall: 86, keyStat: '1,020 rec yds' },
    ...
    { name: 'Rasul Douglas', position: 'CB', overall: 82, keyStat: '4 INTs' },
  ]},
  ...
  { id: 'CIN', name: 'Bengals', city: 'Cincinnati', rating: 92, color: '#FB4F14', roster: [], players: [
    ...
    { name: 'Chase Brown', position: 'RB', overall: 82, keyStat: '898 rush yds' },
  ...
  { id: 'MIA', name: 'Dolphins', city: 'Miami', rating: 91, color: '#008E97', roster: [], players: [
    ...
    { name: 'Calais Campbell', position: 'DT', overall: 84, keyStat: '6 sacks' },
  ...
  { id: 'NYJ', name: 'Jets', city: 'New York', rating: 88, color: '#125740', roster: [], players: [
    ...
    { name: 'Quincy Williams', position: 'LB', overall: 83, keyStat: '112 tackles' },
  ...
  { id: 'CLE', name: 'Browns', city: 'Cleveland', rating: 87, color: '#311D00', roster: [], players: [
    ...
    { name: 'Jerry Jeudy', position: 'WR', overall: 84, keyStat: '1,052 rec yds' },
  ...
  { id: 'IND', name: 'Colts', city: 'Indianapolis', rating: 84, color: '#002C5F', roster: [], players: [
    ...
    { name: 'Zaire Franklin', position: 'LB', overall: 85, keyStat: '132 tackles' },
  ...
  { id: 'NE', name: 'Patriots', city: 'New England', rating: 80, color: '#002244', roster: [], players: [
    ...
    { name: 'Keion White', position: 'DE', overall: 83, keyStat: '8 sacks' },
  ...
  { id: 'DEN', name: 'Broncos', city: 'Denver', rating: 83, color: '#FB4F14', roster: [], players: [
    ...
    { name: 'Zach Allen', position: 'DE', overall: 84, keyStat: '9 sacks' },
  ...
  { id: 'SEA', name: 'Seahawks', city: 'Seattle', rating: 85, color: '#002244', roster: [], players: [
    ...
    { name: 'Tyrel Dodson', position: 'LB', overall: 82, keyStat: '118 tackles' },
    { name: 'Boye Mafe', position: 'DE', overall: 83, keyStat: '9 sacks' },
    { name: 'Devon Witherspoon', position: 'CB', overall: 87, keyStat: '5 INTs' },
    { name: 'Julian Love', position: 'S', overall: 83, keyStat: '4 INTs' },
  ...
  { id: 'TB', name: 'Buccaneers', city: 'Tampa Bay', rating: 85, color: '#D50A0A', roster: [], players: [
    ...
    { name: 'Zyon McCollum', position: 'CB', overall: 81, keyStat: '3 INTs' },
  ...
  { id: 'CAR', name: 'Panthers', city: 'Carolina', rating: 76, color: '#0085CA', roster: [], players: [
    ...
    { name: 'Diontae Johnson', position: 'WR', overall: 80, keyStat: '640 rec yds' },
  ]},
  { id: 'NYG', name: 'Giants', city: 'New York', rating: 77, color: '#0B2265', roster: [], players: [
    ...
    { name: 'Tyler Nubin', position: 'S', overall: 80, keyStat: '3 INTs' },
    { name: "Adoree' Jackson", position: 'CB', overall: 80, keyStat: '3 INTs' },
    { name: 'Daniel Bellinger', position: 'TE', overall: 78, keyStat: '440 rec yds' },
...
export const INITIAL_TERRITORIES: Record<string, string> = {
  WA: 'SEA', CA_N: 'SF', CA_S: 'LAR', CA_SC: 'LAC', NV: 'LV', AZ: 'ARI', CO: 'DEN', OR: 'SEA',
