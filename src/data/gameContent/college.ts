    ...
    faqs: [
      {
        ...
        a: "Same 3x3 bones, different angle. The NFL grid asks which team a player suited up for. This one asks where he went to school, crossed with his position, the Heisman or where he went in the draft.",
      },
      {
        q: "Why didn't that guess cost me anything?",
        a: "A guess only costs a turn when our records say no. If they can't settle it, like a player with no position on file, you get a note saying what they do have on him and your guess count stays put. A school we don't have him at is never charged either, because our records of players moving between schools aren't complete.",
      },
      {
      ...
      },
      {
        ...
        a: "No. Each player goes on the board once. Joe Burrow can fill LSU plus Quarterback or Ohio State plus Quarterback, but not both.",
      },
      {
        q: "What counts as a position?",
        a: "The spots our draft and roster records list him at. Some players are listed at two, and then either one counts: Chase Young fits Ohio State plus Defensive Lineman and Ohio State plus Linebacker.",
      },
      {
