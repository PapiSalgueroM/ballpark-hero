...
const scorePredictorPuzzles: ScorePredictorPuzzle[] = [
  ...
  // ── NBA ──
  { id: 'nba-1', sport: 'nba', homeTeam: 'Golden State Warriors', awayTeam: 'Cleveland Cavaliers', competition: 'NBA Finals Game 7', date: 'June 19, 2016', hint: 'The Block, The Shot, The Stop: down 3-1', homeScore: 89, awayScore: 93, funFact: 'Cleveland became the first team to rally from a 3-1 Finals deficit.' },
  { id: 'nba-2', sport: 'nba', homeTeam: 'Utah Jazz', awayTeam: 'Chicago Bulls', competition: 'NBA Finals Game 6', date: 'June 14, 1998', hint: 'Jordan\'s last shot as a Bull', homeScore: 86, awayScore: 87, funFact: 'MJ hit the game-winning shot with 5.2 seconds left for his 6th title.' },
  ...
  { id: 'nba-5', sport: 'nba', homeTeam: 'Miami Heat', awayTeam: 'San Antonio Spurs', competition: 'NBA Finals Game 6', date: 'June 18, 2013', hint: 'Ray Allen\'s clutch three-pointer', homeScore: 103, awayScore: 100, funFact: 'Ray Allen hit a corner three with 5.2 seconds left to force overtime.' },
  { id: 'nba-6', sport: 'nba', homeTeam: 'Golden State Warriors', awayTeam: 'Oklahoma City Thunder', competition: 'WCF Game 7', date: 'May 30, 2016', hint: 'Oracle Arena, winner goes to the Finals', homeScore: 96, awayScore: 88, funFact: 'Golden State came back from 3-1 down in the series to reach the Finals.' },
  { id: 'nba-7', sport: 'nba', homeTeam: 'Los Angeles Lakers', awayTeam: 'Boston Celtics', competition: 'NBA Finals Game 4', date: 'June 12, 2008', hint: 'The biggest comeback in Finals history (at the time)', homeScore: 91, awayScore: 97, funFact: 'The Celtics erased a 24-point deficit to win.' },
  { id: 'nba-8', sport: 'nba', homeTeam: 'Miami Heat', awayTeam: 'Dallas Mavericks', competition: 'NBA Finals Game 6', date: 'June 12, 2011', hint: 'Dirk\'s moment: dethroning the Big Three', homeScore: 95, awayScore: 105, funFact: 'Nowitzki won his only championship, denying LeBron\'s first ring with Miami.' },
  { id: 'nba-9', sport: 'nba', homeTeam: 'Los Angeles Lakers', awayTeam: 'Philadelphia 76ers', competition: 'NBA Finals Game 1', date: 'June 6, 2001', hint: 'Iverson steps over Lue', homeScore: 101, awayScore: 107, funFact: 'The 76ers stunned the heavily favoured Lakers in OT, their only win of the series.' },
