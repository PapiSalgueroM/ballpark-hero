...
const scorePredictorPuzzles: ScorePredictorPuzzle[] = [
  ...
  { id: 'nfl-6', sport: 'nfl', homeTeam: 'Denver Broncos', awayTeam: 'Carolina Panthers', competition: 'Super Bowl 50', date: 'February 7, 2016', hint: 'Peyton Manning\'s farewell ride', homeScore: 24, awayScore: 10, funFact: 'Manning retired as a champion — the Broncos\' defense dominated Cam Newton.' },
  ...
  { id: 'nba-6', sport: 'nba', homeTeam: 'Golden State Warriors', awayTeam: 'Oklahoma City Thunder', competition: 'WCF Game 7', date: 'May 30, 2016', hint: 'Klay Thompson\'s record-breaking performance', homeScore: 96, awayScore: 88, funFact: 'Warriors came back from 3-1 down — Klay scored 11 straight in the 4th quarter.' },
