...
export const hockeyHLPlayers: HockeyHLPlayer[] = [
  ...
  { name: 'Sidney Crosby', position: 'Forward', country: 'Canada', countryFlag: '🇨🇦', careerPoints: 1620, teams: 'Pittsburgh' },
  { name: 'Alexander Ovechkin', position: 'Forward', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 1610, teams: 'Washington' },
  ...
  { name: 'Patrick Kane', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 1250, teams: 'Chicago, New York Rangers, Detroit' },
  ...
  { name: 'Auston Matthews', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 690, teams: 'Toronto' },
  { name: 'Nikita Kucherov', position: 'Forward', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 880, teams: 'Tampa Bay' },
  { name: 'Leon Draisaitl', position: 'Forward', country: 'Germany', countryFlag: '🇩🇪', careerPoints: 920, teams: 'Edmonton' },
  { name: 'Cale Makar', position: 'Defense', country: 'Canada', countryFlag: '🇨🇦', careerPoints: 420, teams: 'Colorado' },
  ...
  { name: 'Evgeni Malkin', position: 'Forward', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 1160, teams: 'Pittsburgh' },
  { name: 'Claude Giroux', position: 'Forward', country: 'Canada', countryFlag: '🇨🇦', careerPoints: 940, teams: 'Philadelphia, Ottawa' },
  ...
  { name: 'Erik Karlsson', position: 'Defense', country: 'Sweden', countryFlag: '🇸🇪', careerPoints: 760, teams: 'Ottawa, San Jose, Pittsburgh' },
  { name: 'Mikko Rantanen', position: 'Forward', country: 'Finland', countryFlag: '🇫🇮', careerPoints: 650, teams: 'Colorado, Carolina' },
  { name: 'David Pastrnak', position: 'Forward', country: 'Czech Republic', countryFlag: '🇨🇿', careerPoints: 620, teams: 'Boston' },
  { name: 'Jack Eichel', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 530, teams: 'Buffalo, Vegas' },
  { name: 'Artemi Panarin', position: 'Forward', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 700, teams: 'Chicago, Columbus, New York Rangers' },
  { name: 'Steven Stamkos', position: 'Forward', country: 'Canada', countryFlag: '🇨🇦', careerPoints: 1060, teams: 'Tampa Bay, Nashville' },
  { name: 'Jonathan Toews', position: 'Forward', country: 'Canada', countryFlag: '🇨🇦', careerPoints: 827, teams: 'Chicago' },
  { name: 'Anze Kopitar', position: 'Forward', country: 'Slovenia', countryFlag: '🇸🇮', careerPoints: 1040, teams: 'Los Angeles' },
  { name: 'Victor Hedman', position: 'Defense', country: 'Sweden', countryFlag: '🇸🇪', careerPoints: 680, teams: 'Tampa Bay' },
  { name: 'Kirill Kaprizov', position: 'Forward', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 430, teams: 'Minnesota' },
  { name: 'Jason Robertson', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 310, teams: 'Dallas' },
  { name: 'Matthew Tkachuk', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 540, teams: 'Calgary, Florida' },
  { name: 'Brady Tkachuk', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 380, teams: 'Ottawa' },
  { name: 'Igor Shesterkin', position: 'Goalie', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 18, teams: 'New York Rangers' },
];
