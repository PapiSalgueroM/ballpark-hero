...
export const hockeyHLPlayers: HockeyHLPlayer[] = [
  ...
  { name: 'Alexander Ovechkin', position: 'Forward', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 1548, teams: 'Washington' },
  ...
  { name: 'Patrick Kane', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 1224, teams: 'Chicago, New York Rangers, Detroit' },
  { name: 'Connor McDavid', position: 'Forward', country: 'Canada', countryFlag: '🇨🇦', careerPoints: 955, teams: 'Edmonton' },
  { name: 'Nathan MacKinnon', position: 'Forward', country: 'Canada', countryFlag: '🇨🇦', careerPoints: 810, teams: 'Colorado' },
  { name: 'Auston Matthews', position: 'Forward', country: 'United States', countryFlag: '🇺🇸', careerPoints: 640, teams: 'Toronto' },
  { name: 'Nikita Kucherov', position: 'Forward', country: 'Russia', countryFlag: '🇷🇺', careerPoints: 760, teams: 'Tampa Bay' },
  { name: 'Leon Draisaitl', position: 'Forward', country: 'Germany', countryFlag: '🇩🇪', careerPoints: 820, teams: 'Edmonton' },
