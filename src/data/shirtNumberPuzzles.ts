...
const shirtNumberPuzzles: ShirtNumberPuzzle[] = [
  ...
  { playerName: 'Kevin De Bruyne', club: 'Manchester City', league: 'Premier League', nationality: '🇧🇪', kitNumber: 17, funFact: 'An unusual number for a star midfielder — KDB made it his own.' },
