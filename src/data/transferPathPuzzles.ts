...
const transferPathPuzzles: TransferPathPuzzle[] = [
  ...
  },
  {
    ...
    oneOptimalPath: ['Andrea Pirlo', 'Carlos Tevez', 'Cristiano Ronaldo'],
    hint: 'One middle man does it. He was at Juventus with Andrea Pirlo and at Manchester United with Cristiano Ronaldo.',
    active: null,
    europe: { minSteps: 2, oneOptimalPath: ['Andrea Pirlo', 'Carlos Tevez', 'Cristiano Ronaldo'], hint: 'One middle man does it. He was at Juventus with Andrea Pirlo and at Manchester United with Cristiano Ronaldo.' },
  },
  {
  ...
  },
  {
    ...
    oneOptimalPath: ['Steven Gerrard', 'Xabi Alonso', 'Cristiano Ronaldo'],
    hint: 'One middle man does it. He was at Liverpool with Steven Gerrard and at Real Madrid with Cristiano Ronaldo.',
    active: null,
    europe: { minSteps: 2, oneOptimalPath: ['Steven Gerrard', 'Xabi Alonso', 'Cristiano Ronaldo'], hint: 'One middle man does it. He was at Liverpool with Steven Gerrard and at Real Madrid with Cristiano Ronaldo.' },
  },
  {
    id: 'tp-6', playerA: 'Frank Lampard', playerB: 'Lionel Messi', minSteps: 2,
    oneOptimalPath: ['Frank Lampard', 'Deco', 'Lionel Messi'],
    hint: 'One middle man does it. He was at Chelsea with Frank Lampard and at Barcelona with Lionel Messi.',
    active: null,
    europe: { minSteps: 2, oneOptimalPath: ['Frank Lampard', 'Deco', 'Lionel Messi'], hint: 'One middle man does it. He was at Chelsea with Frank Lampard and at Barcelona with Lionel Messi.' },
  },
  {
  ...
  },
  {
    ...
    oneOptimalPath: ['Mohamed Salah', 'Ashley Cole', 'Zlatan Ibrahimović'],
    hint: 'One middle man does it. He was at Chelsea with Mohamed Salah and at LA Galaxy with Zlatan Ibrahimović.',
    active: null,
    europe: { minSteps: 2, oneOptimalPath: ['Mohamed Salah', 'David Luiz', 'Zlatan Ibrahimović'], hint: 'One middle man does it. He was at Chelsea with Mohamed Salah and at PSG with Zlatan Ibrahimović.' },
  },
  {
