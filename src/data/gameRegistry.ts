...
export const CATEGORIES: GameCategory[] = [
  {
    ...
    games: [
      ...
      { path: '/club-manager', label: 'Club Manager', emoji: '💼', description: 'Manage any of 320 real clubs across 19 leagues, today or in a real past season: negotiations, board objectives, trophies and the sack race', isNew: true, featured: true },
