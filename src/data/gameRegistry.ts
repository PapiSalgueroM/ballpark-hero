...
export const CATEGORIES: GameCategory[] = [
  {
    ...
    games: [
      ...
      { path: '/club-manager', label: 'Club Manager', emoji: '💼', description: 'Manage any of 270 real clubs across 13 leagues, today or in the real 2010-11 season: negotiations, board objectives, trophies and the sack race', isNew: true, featured: true },
      { path: '/stadium-tycoon', label: 'Stadium Tycoon', emoji: '🏟️', description: 'Idle empire: grow a tiny club with live toy matches, win streaks and reputation stars', isNew: true },
