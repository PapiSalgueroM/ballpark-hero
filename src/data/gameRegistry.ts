...
export const CATEGORIES: GameCategory[] = [
  {
    ...
    games: [
      ...
      { path: '/soccer-conquest', label: 'Soccer Conquest', emoji: '🗺️', description: 'Play the 96 club Daily Season across Europe or an unlimited England Attack with direction spins, captures and saved runs', daily: true, addedOn: '2026-09-05' },
