...
export const UFC_FIGHTERS: UfcFighter[] = [
  ...
  { name: 'Stipe Miocic', weightClass: 'Heavyweight', record: '20-5-0', wins: 20, losses: 5, draws: 0, isHallOfFamer: true },
  ...
  { name: 'Ciryl Gane', weightClass: 'Heavyweight', record: '13-3-0', wins: 13, losses: 3, draws: 0, isHallOfFamer: false },

  // Light Heavyweights
  { name: 'Alex Pereira', weightClass: 'Light Heavyweight', record: '13-2-0', wins: 13, losses: 2, draws: 0, isHallOfFamer: false },
  { name: 'Jamahal Hill', weightClass: 'Light Heavyweight', record: '12-3-0', wins: 12, losses: 3, draws: 0, isHallOfFamer: false },
  { name: 'Glover Teixeira', weightClass: 'Light Heavyweight', record: '33-10-0', wins: 33, losses: 10, draws: 0, isHallOfFamer: false },
  { name: 'Jan Blachowicz', weightClass: 'Light Heavyweight', record: '29-10-1', wins: 29, losses: 10, draws: 1, isHallOfFamer: false },
  { name: 'Jiří Procházka', weightClass: 'Light Heavyweight', record: '30-5-1', wins: 30, losses: 5, draws: 1, isHallOfFamer: false },
  ...
  // Middleweights  
  { name: 'Israel Adesanya', weightClass: 'Middleweight', record: '24-4-0', wins: 24, losses: 4, draws: 0, isHallOfFamer: false },
  { name: 'Dricus du Plessis', weightClass: 'Middleweight', record: '22-3-0', wins: 22, losses: 3, draws: 0, isHallOfFamer: false },
  { name: 'Sean Strickland', weightClass: 'Middleweight', record: '29-6-0', wins: 29, losses: 6, draws: 0, isHallOfFamer: false },
  { name: 'Robert Whittaker', weightClass: 'Middleweight', record: '25-7-0', wins: 25, losses: 7, draws: 0, isHallOfFamer: false },
  { name: 'Paulo Costa', weightClass: 'Middleweight', record: '14-4-0', wins: 14, losses: 4, draws: 0, isHallOfFamer: false },
  ...
  // Welterweights
  { name: 'Leon Edwards', weightClass: 'Welterweight', record: '22-5-1', wins: 22, losses: 5, draws: 1, isHallOfFamer: false },
  { name: 'Belal Muhammad', weightClass: 'Welterweight', record: '24-4-1', wins: 24, losses: 4, draws: 1, isHallOfFamer: false },
  ...
  { name: 'Robbie Lawler', weightClass: 'Welterweight', record: '29-15-0', wins: 29, losses: 15, draws: 0, isHallOfFamer: true },
  ...
  // Lightweights
  { name: 'Islam Makhachev', weightClass: 'Lightweight', record: '28-1-0', wins: 28, losses: 1, draws: 0, isHallOfFamer: false },
  { name: 'Arman Tsarukyan', weightClass: 'Lightweight', record: '22-3-0', wins: 22, losses: 3, draws: 0, isHallOfFamer: false },
  { name: 'Charles Oliveira', weightClass: 'Lightweight', record: '35-10-0', wins: 35, losses: 10, draws: 0, isHallOfFamer: false },
  { name: 'Justin Gaethje', weightClass: 'Lightweight', record: '25-5-0', wins: 25, losses: 5, draws: 0, isHallOfFamer: false },
  { name: 'Dustin Poirier', weightClass: 'Lightweight', record: '30-9-0', wins: 30, losses: 9, draws: 0, isHallOfFamer: false },
  ...
  { name: 'Tony Ferguson', weightClass: 'Lightweight', record: '25-11-0', wins: 25, losses: 11, draws: 0, isHallOfFamer: false },
  { name: 'BJ Penn', weightClass: 'Lightweight', record: '16-14-2', wins: 16, losses: 14, draws: 2, isHallOfFamer: true },

  // Featherweights
  { name: 'Ilia Topuria', weightClass: 'Featherweight', record: '16-0-0', wins: 16, losses: 0, draws: 0, isHallOfFamer: false },
  { name: 'Alexander Volkanovski', weightClass: 'Featherweight', record: '26-4-0', wins: 26, losses: 4, draws: 0, isHallOfFamer: false },
  { name: 'Max Holloway', weightClass: 'Featherweight', record: '26-8-0', wins: 26, losses: 8, draws: 0, isHallOfFamer: false },
  { name: 'Diego Lopes', weightClass: 'Featherweight', record: '27-6-0', wins: 27, losses: 6, draws: 0, isHallOfFamer: false },
  { name: 'Movsar Evloev', weightClass: 'Featherweight', record: '20-0-0', wins: 20, losses: 0, draws: 0, isHallOfFamer: false },
  { name: 'Brian Ortega', weightClass: 'Featherweight', record: '16-4-0', wins: 16, losses: 4, draws: 0, isHallOfFamer: false },
  ...
  // Bantamweights
  { name: 'Merab Dvalishvili', weightClass: 'Bantamweight', record: '19-4-0', wins: 19, losses: 4, draws: 0, isHallOfFamer: false },
  { name: 'Sean O\'Malley', weightClass: 'Bantamweight', record: '18-3-0', wins: 18, losses: 3, draws: 0, isHallOfFamer: false },
  { name: 'Aljamain Sterling', weightClass: 'Bantamweight', record: '24-4-0', wins: 24, losses: 4, draws: 0, isHallOfFamer: false },
  { name: 'Petr Yan', weightClass: 'Bantamweight', record: '17-5-0', wins: 17, losses: 5, draws: 0, isHallOfFamer: false },
  ...
  // Flyweights
  { name: 'Alexandre Pantoja', weightClass: 'Flyweight', record: '28-5-0', wins: 28, losses: 5, draws: 0, isHallOfFamer: false },
  { name: 'Brandon Moreno', weightClass: 'Flyweight', record: '21-8-2', wins: 21, losses: 8, draws: 2, isHallOfFamer: false },
  { name: 'Deiveson Figueiredo', weightClass: 'Flyweight', record: '24-4-1', wins: 24, losses: 4, draws: 1, isHallOfFamer: false },
  ...
  { name: 'Henry Cejudo', weightClass: 'Flyweight', record: '16-4-0', wins: 16, losses: 4, draws: 0, isHallOfFamer: true },
];
...
export const FIGHT_RESULTS: FightResult[] = [
  ...
  { winner: 'Tom Aspinall', loser: 'Jon Jones', event: 'UFC 313', method: 'TKO', round: 2, time: '3:45', wasChampionshipFight: true },
  ...
  { winner: 'Francis Ngannou', loser: 'Ciryl Gane', event: 'UFC 270', method: 'Decision', round: 5, time: '5:00', wasChampionshipFight: true },
  { winner: 'Daniel Cormier', loser: 'Stipe Miocic', event: 'UFC 226', method: 'KO', round: 1, time: '4:33', wasChampionshipFight: true },
  { winner: 'Tom Aspinall', loser: 'Ciryl Gane', event: 'UFC Fight Night', method: 'TKO', round: 1, time: '1:02', wasChampionshipFight: false },
  ...
  { winner: 'Alex Pereira', loser: 'Jiří Procházka', event: 'UFC 303', method: 'KO', round: 2, time: '4:32', wasChampionshipFight: true },
  ...
  { winner: 'Jiří Procházka', loser: 'Glover Teixeira', event: 'UFC 275', method: 'Submission', round: 5, time: '4:32', wasChampionshipFight: true },
  ...
  // Middleweight fights
  { winner: 'Dricus du Plessis', loser: 'Israel Adesanya', event: 'UFC 305', method: 'Submission', round: 4, time: '2:51', wasChampionshipFight: true },
  { winner: 'Dricus du Plessis', loser: 'Sean Strickland', event: 'UFC 297', method: 'Decision', round: 5, time: '5:00', wasChampionshipFight: true },
  ...
  { winner: 'Leon Edwards', loser: 'Colby Covington', event: 'UFC 296', method: 'Decision', round: 5, time: '5:00', wasChampionshipFight: true },
  { winner: 'Belal Muhammad', loser: 'Leon Edwards', event: 'UFC 304', method: 'Decision', round: 5, time: '5:00', wasChampionshipFight: true },
  ...
  { winner: 'Islam Makhachev', loser: 'Dustin Poirier', event: 'UFC 302', method: 'Submission', round: 5, time: '3:14', wasChampionshipFight: true },
  { winner: 'Islam Makhachev', loser: 'Arman Tsarukyan', event: 'UFC 311', method: 'Submission', round: 1, time: '4:42', wasChampionshipFight: true },
  ...
  { winner: 'Ilia Topuria', loser: 'Max Holloway', event: 'UFC 308', method: 'KO', round: 3, time: '1:34', wasChampionshipFight: true },
  ...
  // Bantamweight fights
  { winner: 'Merab Dvalishvili', loser: 'Sean O\'Malley', event: 'UFC 306', method: 'Decision', round: 5, time: '5:00', wasChampionshipFight: true },
