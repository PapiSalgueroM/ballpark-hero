  ...
  return (
    <>
      <PageSeo
        ...
        description="Territory conquest with NFL teams. Draft players and conquer the US map. Strategy meets football trivia."
        path="/conquest"
      />
      <div className="min-h-screen bg-background text-foreground">
        ...
        <main id="dukb-main" className="container max-w-2xl mx-auto px-4 py-6 pb-20">
          ...
          {mode === 'imperialism' && (
            <ImperialismBoardShared sport={NFL_IMPERIALISM} map={NFL_CONQUEST_MAP} game={NFL_CONQUEST_GAME} helpOpen={showImpHelp} onHelpOpenChange={setShowImpHelp} />
          )}
          ...
          pageHasOwnH1
            ...
            howToPlay={[
              ...
              "Press Play and every game in the week plays out on the map one at a time: the wheel lands on the attacker, the map zooms in, the final score lands, and the loser's states turn the winner's colour. Skip jumps to the results, and the timeline under the map shows the map after any earlier week.",
