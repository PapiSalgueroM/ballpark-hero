...
// stint, so the search layer's dedupe-by-name path handles the repeats;
// `seasons` is a rough prominence signal (long careers surface first).
const NFL_STINTS_PLAYER_SOURCE: PlayerSourceConfig = {
  table: 'nfl_player_team_stints',
...
const NflConnect4 = () => {
  ...
  return (
    <>
      <PageSeo
        title="NFL Connect 4 - Football Trivia Grid Game | DoUKnowBall"
        description="Play Connect 4 with NFL trivia. Name players matching franchise and stat criteria to claim cells."
        path="/nfl-connect-4"
      />
      <GameShell
        width="wide"
      ...
      >
            ...
            <div className="flex items-start gap-2">
              <div className="flex-1">
                <PlayerAutocomplete
                  ...
                  searchOptions={{ source: NFL_STINTS_PLAYER_SOURCE, exclude: usedPlayers }}
                  placeholder="Enter any NFL player (any era)..."
        ...
        {(phase === 'won' || phase === 'draw') && (
          <div className="flex flex-col items-center mt-6">
            <ShareButtons
              ...
              gameName="NFL Connect 4"
              gamePath="/nfl-connect-4"
            />
            <button
              onClick={resetGame}
        ...
        <GameSeoContent
          ...
          howToPlay={[
            ...
            "Name an NFL player who matches both the column and row criteria",
            "Valid answers place your piece. First to get 4 in a row wins",
            "Each player can only be used once per game",
            "Franchise history counts across relocations (Oilers = Titans)",
          ]}
          examples={[
            "Patriots + Super Bowl MVP = Tom Brady, Julian Edelman",
            "Colts + 40,000+ Passing Yards = Peyton Manning, Philip Rivers",
            "Lions + League MVP = Barry Sanders",
            "Cardinals + Undrafted = Kurt Warner",
            "Steelers + Defensive Player of the Year = Troy Polamalu, T.J. Watt",
          ]}
        />
