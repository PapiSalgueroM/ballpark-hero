  ...
  return (
    <>
      ...
      <GameSeoContent
        ...
        description="One billion dollars, real transfer market values, eleven slots. Choose any formation, filter by competition, and build the strongest XI your budget allows. Overspend and you cannot field the team, the whole game is deciding where the money goes."
        howToPlay={[
          'You start with $1,000M, one billion dollars.',
