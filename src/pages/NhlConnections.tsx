  ...
  return (
    <>
      ...
      >
        ...
        {!isLoading && gameStatus === 'complete' && (
          <div className="mt-6 flex justify-center">
            <ResultScreen
              ...
              emojiGrid={lives > 0 ? `🏆 NHL Connections: all 4 groups, ${lives} ${lives === 1 ? 'life' : 'lives'} left` : `🏒 NHL Connections: ${solvedGroups.length}/4 groups`}
              share={{
                score: lives > 0 ? `all 4 groups with ${lives} ${lives === 1 ? 'life' : 'lives'} left on today's NHL Connections` : `today's NHL Connections`,
        ...
        <AdBanner slot="1234567908" format="horizontal" className="mt-8" />
