      ...
      >
        ...
        <GameSeoContent
          ...
          howToPlay={[
            ...
            'Sign free agents any time, even with the window shut: made up journeymen without a club, marked MADE UP, and players whose deals ran out with you a season earlier. Only men a level below your club will sign, for no fee, on the wage and contract length shown on the button.',
