    ...
    <>
      ...
      <GameShell width="wide">
        <div className="relative">
          <HowToPlayPopover title="How to Play Club Manager" triggerSide="right">
            <div className="space-y-3 text-left">
              ...
              <p>💰 <span className="font-semibold text-foreground">Buy and sell in the summer and January windows.</span> Over 3,400 real players are on the market at their real values. Stay under budget and keep at least 14 players.</p>
        ...
        <GameSeoContent
          ...
          description="A full club-management sim in your browser: 296 clubs across 17 real leagues, from the Premier League, the 2. Bundesliga and the Scottish Premiership to the Saudi Pro League, MLS, Austria and Greece, each with its real squad and market values as of August 2026. Manage today or in a real past season: 2015-16 with Leicester at 5000 to 1, 2010-11 with prime Messi, or 2005-06 with Ronaldinho's Barcelona. Or create your own club with its own crest and stadium. Negotiate transfers, survive bidding wars, hit the board's named objectives, and chase titles season after season."
          howToPlay={[
            'Pick your era: 2026-27 with real squads, or the real 2015-16, 2010-11 or 2005-06 Premier League and La Liga.',
            'Pick your nation, league and club (296 clubs across 17 real leagues), or create your own club with its own crest, stadium and budget.',
