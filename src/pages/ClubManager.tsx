        ...
        <div className="relative">
          <HowToPlayPopover title="How to Play Club Manager" triggerSide="right">
            <div className="space-y-3 text-left">
              <p>🌍 <span className="font-semibold text-foreground">Pick any club in 19 real leagues.</span> The big five (2026-27 lineups with promotions and relegations applied), the EFL Championship and the 2. Bundesliga, the Primeira Liga, the Scottish Premiership, the Süper Lig, the Belgian Pro League, the Austrian Bundesliga, the Super League Greece, the Danish Superliga, the Swiss Super League, the Saudi Pro League, both MLS conferences and the Eredivisie: 320 clubs and over 3,500 real players, each squad at its real market values as of August 2026, after the summer window. Giants get huge budgets and zero patience; underdogs get small budgets and a low bar.</p>
              ...
              <p>💰 <span className="font-semibold text-foreground">Buy and sell in the summer and January windows.</span> Over 3,500 real players are on the market at their real values. Stay under budget and keep at least 14 players.</p>
