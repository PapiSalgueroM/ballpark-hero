...
const RELATED = [
  ...
  { path: '/records/stanley-cup-winners', label: 'Stanley Cup winners since 1915, year by year', why: 'from the Record Books, with 1919 and 2005 left blank on purpose' },
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main id="dukb-main" tabIndex={-1} className="flex-1 max-w-3xl mx-auto w-full px-4 pt-6 pb-16">
        ...
        <section className="mb-10">
          <h2 className="text-lg font-display font-bold text-foreground mb-3">NHL playoff format timeline at a glance</h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-display font-bold text-foreground mb-3">NHL playoff format, season by season</h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-display font-bold text-foreground mb-3">NHL playoff format: questions people ask</h2>
          <div className="space-y-4">
            {FAQS.map(f => (
              <div key={f.q}>
