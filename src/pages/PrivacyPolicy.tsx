    ...
    <div className="min-h-screen bg-background text-foreground px-4 py-12 max-w-3xl mx-auto">
      ...
      <section className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        <div>
          ...
          <p>DoUKnowBall is free to use without an account. If you choose to use certain features, here is what we collect:</p>
        ...
        <div>
          ...
          <p className="mt-2">You have the right to ask what data we have about you, correct it, or have it deleted. To do this, or for any privacy question, contact us at <a href="mailto:footyfein1@gmail.com" className="underline hover:text-foreground transition-colors">footyfein1@gmail.com</a> and we will respond within 30 days.</p>
        </div>
        ...
        <div>
          ...
          <p>If you have any questions about this privacy policy, want to request access to or deletion of your data, or have a general concern, please contact us at <a href="mailto:footyfein1@gmail.com" className="underline hover:text-foreground transition-colors">footyfein1@gmail.com</a>. For issues with a specific question or answer in a game, you can also use the "Report" button on that game.</p>
        </div>
      </section>
