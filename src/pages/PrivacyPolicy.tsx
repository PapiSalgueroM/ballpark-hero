...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground px-4 py-12 max-w-3xl mx-auto">
      ...
      <p className="text-sm text-muted-foreground mb-6">Last updated: August 25, 2026</p>
      ...
      <section className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <p className="mt-2">Third-party services (such as Google AdSense) use cookies and similar technologies to serve ads, including personalized ads based on your browsing activity. Those cookies are governed by the third party's own privacy policy. Section 5 explains what they do and how to opt out of personalization.</p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li><strong>Google AdSense:</strong> We display advertisements provided by Google AdSense, including personalized ads, and only after you have chosen Accept on our cookie banner. Google may use cookies and web beacons to serve ads based on your prior visits to this or other websites. Section 5 has the full advertising disclosure and every opt-out link, including <a href="https://www.google.com/settings/ads" className="underline hover:text-foreground transition-colors" target="_blank" rel="noopener noreferrer">Google's Ads Settings</a>.</li>
            <li><strong>Google Analytics:</strong> We use Google Analytics 4 to see which games people play and how the Site is used, so we know what to build next. It loads only after you choose Accept on our cookie banner, and it uses cookies to tell one visit from another. Google Analytics 4 does not log or store IP addresses. You can also opt out of Google Analytics everywhere with <a href="https://tools.google.com/dlpage/gaoptout" className="underline hover:text-foreground transition-colors" target="_blank" rel="noopener noreferrer">Google's browser add-on</a>.</li>
        ...
        <div>
          ...
          <p>Ads are how the games stay free. We use Google AdSense, and here is what that means in practice, in the words Google asks publishers to use:</p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
        ...
        <div>
          ...
          <p className="mt-2"><strong>If you are a California resident,</strong> you have the right to know what personal information we collect and how it is used, to request its deletion, to correct inaccurate information, and not to be treated differently for exercising any of those rights. We do not sell personal information. Showing you personalized ads through Google may count as "sharing" personal information under California law; choosing Essential only on the banner, or using the Cookie choices link in the footer, opts you out of that on this site.</p>
        </div>
