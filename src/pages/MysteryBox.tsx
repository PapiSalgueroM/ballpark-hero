...
export default function MysteryBox() {
  return (
    <main id="dukb-main" tabIndex={-1} className="min-h-screen min-h-[100dvh] overflow-x-hidden bg-background">
      <PageSeo
      ...
      />
      <GameNavbar />
      <div className="relative z-10 mx-auto w-full max-w-4xl overflow-x-hidden"><GameHelp /></div>
      <MysteryBoxBoard />
      <GameEditorialGuide path="/mystery-box" />
      <GameSeoContent
        omitLongGuide
        ...
        howToPlay={[
          'Spin the wheel, then the pack flips. Skip animation if you want the card now.',
          'Open packs one at a time, 15 in total. The wheel lands on that pack\'s tier, it does not re-roll.',
