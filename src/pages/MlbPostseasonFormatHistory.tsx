...
const RELATED = [
  ...
  { path: '/records/world-series-winners', label: 'World Series winners since 1903, year by year', why: 'from the Record Books, with 1904 and 1994 left empty on purpose' },
