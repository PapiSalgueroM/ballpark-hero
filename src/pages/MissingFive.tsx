...
const MissingFive = () => {
  ...
  const [unlimitedPuzzle, setUnlimitedPuzzle] = useState<ActiveFivePuzzle | null>(null);
  ...
  const switchMode = useCallback((m: Mode) => {
    if (m === 'unlimited' && unlimitedPuzzle === null) setUnlimitedPuzzle(getRandomFivePuzzle());
    setMode(m);
    setInput('');
  }, [unlimitedPuzzle]);
