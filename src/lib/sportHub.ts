...
export const SPORT_HUBS: SportHub[] = [
  ...
  },
  {
    ...
    referenceLinks: [
      ...
      { path: '/nba-playoff-format-history', label: 'NBA playoff format history', why: 'how the bracket grew from six BAA teams to sixteen plus a play-in, and the draft lottery from the coin flip to the 3-2-1 draw, each change twice sourced' },
