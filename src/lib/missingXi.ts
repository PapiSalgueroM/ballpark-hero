...
export const LINEUPS: Lineup[] = [
  ...
  // -------------------------------------------------------------------------
  // Round 463: 38 more lineups, his words "many more puzzles". Every XI below
  // was read from two independent sources on 2026-09-05 and the eleven names
  // agreed on both before the entry was written: the Wikipedia match article
  // (or the tournament knockout stage article's own section, fetched through
  // the wikitext API so the long page could not be misread) plus Sky Sports'
  // team sheet for that match, or ESPN's lineup page where Sky's sheet was
  // incomplete, or lfchistory.net for Liverpool. Where the two outlets label
  // the shape differently (Sky prints a nominal 4-3-3 for most sides) the
  // formation label follows the positions both sources actually list. Every
  // blank candidate's spelling, nationality and club at the time were checked
  // by SQL against player_market_values the same day, and pre-2004 matches
  // only blank men whose rows reach into the covered years, per the file rule.
  // -------------------------------------------------------------------------

  // 170. 2013 Champions League Final - the LOSING side, Borussia Dortmund 1-2 Bayern Munich.
  {
    id: 'cl-2013-final-dortmund',
    dateLabel: '2013 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2013-05-25',
    team: 'Borussia Dortmund',
    opponent: 'Bayern Munich',
    scoreLine: 'Borussia Dortmund 1-2 Bayern Munich',
    venue: 'Wembley Stadium, London',
    formationLabel: '4-2-3-1',
    slots: [
      GK('Roman Weidenfeller'),
      { position: 'RB', name: 'Lukasz Piszczek', x: 84, y: 70 },
      { position: 'CB', name: 'Neven Subotic', x: 62, y: 74 },
      { position: 'CB', name: 'Mats Hummels', x: 38, y: 74 },
      { position: 'LB', name: 'Marcel Schmelzer', x: 16, y: 70 },
      { position: 'CDM', name: 'Sven Bender', x: 62, y: 56 },
      { position: 'CDM', name: 'Ilkay Gundogan', x: 38, y: 56 },
      { position: 'RW', name: 'Jakub Blaszczykowski', x: 80, y: 26 },
      { position: 'CAM', name: 'Marco Reus', x: 50, y: 40 },
      { position: 'LW', name: 'Kevin Grosskreutz', x: 20, y: 26 },
      { position: 'ST', name: 'Robert Lewandowski', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Neven Subotic', slotIndex: 2, nationality: 'Serbia', clubAtTime: 'Borussia Dortmund' },
      { name: 'Marcel Schmelzer', slotIndex: 4, nationality: 'Germany', clubAtTime: 'Borussia Dortmund' },
      { name: 'Kevin Grosskreutz', slotIndex: 9, nationality: 'Germany', clubAtTime: 'Borussia Dortmund' },
    ],
    source: 'Wikipedia 2013 UEFA Champions League final lineup table + Sky Sports team sheet (borussia-dortmund-vs-bayern-munich/teams/286308), both read 2026-09-05, agree name for name.',
  },

  // 171. 2015 Champions League Final - the LOSING side, Juventus 1-3 Barcelona.
  {
    id: 'cl-2015-final-juventus',
    dateLabel: '2015 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2015-06-06',
    team: 'Juventus',
    opponent: 'Barcelona',
    scoreLine: 'Juventus 1-3 Barcelona',
    venue: 'Olympiastadion, Berlin',
    formationLabel: '4-3-1-2',
    slots: [
      GK('Gianluigi Buffon'),
      { position: 'RB', name: 'Stephan Lichtsteiner', x: 84, y: 70 },
      { position: 'CB', name: 'Andrea Barzagli', x: 62, y: 74 },
      { position: 'CB', name: 'Leonardo Bonucci', x: 38, y: 74 },
      { position: 'LB', name: 'Patrice Evra', x: 16, y: 70 },
      { position: 'CDM', name: 'Andrea Pirlo', x: 50, y: 58 },
      { position: 'CM', name: 'Claudio Marchisio', x: 68, y: 48 },
      { position: 'CM', name: 'Paul Pogba', x: 32, y: 48 },
      { position: 'CAM', name: 'Arturo Vidal', x: 50, y: 34 },
      { position: 'ST', name: 'Carlos Tevez', x: 60, y: 18 },
      { position: 'ST', name: 'Alvaro Morata', x: 40, y: 18 },
    ],
    blankCandidates: [
      { name: 'Stephan Lichtsteiner', slotIndex: 1, nationality: 'Switzerland', clubAtTime: 'Juventus' },
      { name: 'Andrea Barzagli', slotIndex: 2, nationality: 'Italy', clubAtTime: 'Juventus' },
      { name: 'Claudio Marchisio', slotIndex: 6, nationality: 'Italy', clubAtTime: 'Juventus' },
    ],
    source: 'Wikipedia 2015 UEFA Champions League final lineup table + Sky Sports team sheet (juventus-vs-barcelona/teams/335339), both read 2026-09-05, agree name for name.',
  },

  // 172. 2016 Champions League Final - the LOSING side, Atletico Madrid 1-1 Real Madrid (lost 5-3 on penalties).
  {
    id: 'cl-2016-final-atletico',
    dateLabel: '2016 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2016-05-28',
    team: 'Atletico Madrid',
    opponent: 'Real Madrid',
    scoreLine: 'Real Madrid 1-1 Atletico Madrid (Real Madrid won 5-3 on penalties)',
    venue: 'San Siro, Milan',
    formationLabel: '4-4-2',
    slots: [
      GK('Jan Oblak'),
      { position: 'RB', name: 'Juanfran', x: 84, y: 70 },
      { position: 'CB', name: 'Stefan Savic', x: 62, y: 74 },
      { position: 'CB', name: 'Diego Godin', x: 38, y: 74 },
      { position: 'LB', name: 'Filipe Luis', x: 16, y: 70 },
      { position: 'RM', name: 'Saul Niguez', x: 82, y: 48 },
      { position: 'CM', name: 'Gabi', x: 60, y: 52 },
      { position: 'CM', name: 'Augusto Fernandez', x: 40, y: 52 },
      { position: 'LM', name: 'Koke', x: 18, y: 48 },
      { position: 'ST', name: 'Antoine Griezmann', x: 62, y: 18 },
      { position: 'ST', name: 'Fernando Torres', x: 38, y: 18 },
    ],
    // Augusto Fernandez started and was replaced at half time by Carrasco, who scored the equaliser: the sub is the man people remember.
    blankCandidates: [
      { name: 'Stefan Savic', slotIndex: 2, nationality: 'Montenegro', clubAtTime: 'Atletico Madrid' },
      { name: 'Augusto Fernandez', slotIndex: 7, nationality: 'Argentina', clubAtTime: 'Atletico Madrid', fact: 'Started in midfield and made way at half time for Carrasco, who scored the equaliser' },
      { name: 'Filipe Luis', slotIndex: 4, nationality: 'Brazil', clubAtTime: 'Atletico Madrid' },
    ],
    source: 'Wikipedia 2016 UEFA Champions League final lineup table + Sky Sports team sheet (real-madrid-vs-atletico-madrid/teams/355010), both read 2026-09-05, agree name for name including Augusto Fernandez off at 46.',
  },

  // 173. 2017 Champions League Final - the LOSING side, Juventus 1-4 Real Madrid.
  {
    id: 'cl-2017-final-juventus',
    dateLabel: '2017 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2017-06-03',
    team: 'Juventus',
    opponent: 'Real Madrid',
    scoreLine: 'Juventus 1-4 Real Madrid',
    venue: 'Millennium Stadium, Cardiff',
    formationLabel: '3-4-1-2',
    slots: [
      GK('Gianluigi Buffon'),
      { position: 'CB', name: 'Andrea Barzagli', x: 68, y: 76 },
      { position: 'CB', name: 'Leonardo Bonucci', x: 50, y: 78 },
      { position: 'CB', name: 'Giorgio Chiellini', x: 32, y: 76 },
      { position: 'RWB', name: 'Dani Alves', x: 86, y: 52 },
      { position: 'CM', name: 'Miralem Pjanic', x: 62, y: 56 },
      { position: 'CM', name: 'Sami Khedira', x: 38, y: 56 },
      { position: 'LWB', name: 'Alex Sandro', x: 14, y: 52 },
      { position: 'CAM', name: 'Paulo Dybala', x: 50, y: 34 },
      { position: 'ST', name: 'Gonzalo Higuain', x: 60, y: 16 },
    ...
    blankCandidates: [
      { name: 'Alex Sandro', slotIndex: 7, nationality: 'Brazil', clubAtTime: 'Juventus' },
      { name: 'Miralem Pjanic', slotIndex: 5, nationality: 'Bosnia and Herzegovina', clubAtTime: 'Juventus' },
      { name: 'Sami Khedira', slotIndex: 6, nationality: 'Germany', clubAtTime: 'Juventus' },
    ],
    source: 'Wikipedia 2017 UEFA Champions League final lineup table + Sky Sports team sheet (juventus-vs-real-madrid/teams/371636), both read 2026-09-05, agree name for name; both list a back three with Alves and Alex Sandro wide.',
  },

  // 174. 2018 Champions League Final - the LOSING side, Liverpool 1-3 Real Madrid.
  {
    id: 'cl-2018-final-liverpool',
    dateLabel: '2018 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2018-05-26',
    team: 'Liverpool',
    ...
    slots: [
      ...
      { position: 'CB', name: 'Virgil van Dijk', x: 38, y: 74 },
      { position: 'LB', name: 'Andrew Robertson', x: 16, y: 70 },
      { position: 'CDM', name: 'Jordan Henderson', x: 50, y: 58 },
      { position: 'CM', name: 'James Milner', x: 68, y: 50 },
      { position: 'CM', name: 'Georginio Wijnaldum', x: 32, y: 50 },
      { position: 'RW', name: 'Mohamed Salah', x: 80, y: 24 },
      { position: 'CF', name: 'Roberto Firmino', x: 50, y: 18 },
      { position: 'LW', name: 'Sadio Mane', x: 20, y: 24 },
    ...
    blankCandidates: [
      { name: 'Loris Karius', slotIndex: 0, nationality: 'Germany', clubAtTime: 'Liverpool' },
      { name: 'Dejan Lovren', slotIndex: 2, nationality: 'Croatia', clubAtTime: 'Liverpool' },
      { name: 'James Milner', slotIndex: 6, nationality: 'England', clubAtTime: 'Liverpool' },
    ],
    source: 'Wikipedia 2018 UEFA Champions League final lineup table + Sky Sports team sheet (real-madrid-vs-liverpool/teams/389182), both read 2026-09-05, agree name for name.',
  },

  // 175. 2021 Champions League Final - the LOSING side, Manchester City 0-1 Chelsea.
  {
    id: 'cl-2021-final-city',
    dateLabel: '2021 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2021-05-29',
    team: 'Manchester City',
    ...
    venue: 'Estadio do Dragao, Porto',
    formationLabel: '4-3-3',
    // Neither Rodri nor Fernandinho started: Gundogan sat deepest with Bernardo Silva and Foden beside him, and De Bruyne played as the false nine.
    slots: [
      GK('Ederson'),
      { position: 'RB', name: 'Kyle Walker', x: 84, y: 70 },
      { position: 'CB', name: 'John Stones', x: 62, y: 74 },
      { position: 'CB', name: 'Ruben Dias', x: 38, y: 74 },
      { position: 'LB', name: 'Oleksandr Zinchenko', x: 16, y: 70 },
      { position: 'CDM', name: 'Ilkay Gundogan', x: 50, y: 58 },
      { position: 'CM', name: 'Bernardo Silva', x: 68, y: 50 },
      { position: 'CM', name: 'Phil Foden', x: 32, y: 50 },
      { position: 'RW', name: 'Riyad Mahrez', x: 80, y: 24 },
      { position: 'CF', name: 'Kevin De Bruyne', x: 50, y: 18 },
      { position: 'LW', name: 'Raheem Sterling', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Oleksandr Zinchenko', slotIndex: 4, nationality: 'Ukraine', clubAtTime: 'Manchester City' },
      { name: 'Ruben Dias', slotIndex: 3, nationality: 'Portugal', clubAtTime: 'Manchester City' },
      { name: 'Riyad Mahrez', slotIndex: 8, nationality: 'Algeria', clubAtTime: 'Manchester City' },
    ],
    source: 'Wikipedia 2021 UEFA Champions League final lineup table + Sky Sports team sheet (manchester-city-vs-chelsea/teams/442566), both read 2026-09-05, agree name for name and both leave Rodri and Fernandinho on the bench.',
  },

  // 176. 2025 Champions League Final - the LOSING side, Inter Milan 0-5 Paris Saint-Germain.
  {
    id: 'cl-2025-final-inter',
    dateLabel: '2025 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2025-05-31',
    team: 'Inter Milan',
    ...
    slots: [
      GK('Yann Sommer'),
      { position: 'CB', name: 'Benjamin Pavard', x: 68, y: 76 },
      { position: 'CB', name: 'Francesco Acerbi', x: 50, y: 78 },
      { position: 'CB', name: 'Alessandro Bastoni', x: 32, y: 76 },
      { position: 'RWB', name: 'Denzel Dumfries', x: 86, y: 50 },
      { position: 'CM', name: 'Nicolò Barella', x: 68, y: 54 },
      { position: 'CDM', name: 'Hakan Calhanoglu', x: 50, y: 60 },
      { position: 'CM', name: 'Henrikh Mkhitaryan', x: 32, y: 54 },
      { position: 'LWB', name: 'Federico Dimarco', x: 14, y: 50 },
      { position: 'ST', name: 'Marcus Thuram', x: 60, y: 16 },
      { position: 'ST', name: 'Lautaro Martinez', x: 40, y: 16 },
    ],
    blankCandidates: [
      { name: 'Yann Sommer', slotIndex: 0, nationality: 'Switzerland', clubAtTime: 'Inter Milan' },
      { name: 'Denzel Dumfries', slotIndex: 4, nationality: 'Netherlands', clubAtTime: 'Inter Milan' },
      { name: 'Henrikh Mkhitaryan', slotIndex: 7, nationality: 'Armenia', clubAtTime: 'Inter Milan' },
    ],
    source: 'Wikipedia 2025 UEFA Champions League final lineup table + Sky Sports team sheet (paris-saint-germain-vs-inter-milan/teams/522734), both read 2026-09-05, agree name for name.',
  },

  // 177. 2012 Champions League Final - the LOSING side, Bayern Munich 1-1 Chelsea (lost 4-3 on penalties), at their own ground.
  {
    id: 'cl-2012-final-bayern',
    dateLabel: '2012 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2012-05-19',
    team: 'Bayern Munich',
    ...
    venue: 'Allianz Arena, Munich',
    formationLabel: '4-2-3-1',
    // Badstuber and Alaba were both suspended, so Tymoshchuk dropped into the back four beside Boateng and Contento started at left back.
    slots: [
      GK('Manuel Neuer'),
      { position: 'RB', name: 'Philipp Lahm', x: 84, y: 70 },
      { position: 'CB', name: 'Jerome Boateng', x: 62, y: 74 },
      { position: 'CB', name: 'Anatoliy Tymoshchuk', x: 38, y: 74 },
      { position: 'LB', name: 'Diego Contento', x: 16, y: 70 },
      { position: 'CDM', name: 'Bastian Schweinsteiger', x: 62, y: 56 },
      { position: 'CDM', name: 'Toni Kroos', x: 38, y: 56 },
      { position: 'RW', name: 'Arjen Robben', x: 80, y: 26 },
      { position: 'CAM', name: 'Thomas Muller', x: 50, y: 40 },
      { position: 'LW', name: 'Franck Ribery', x: 20, y: 26 },
      { position: 'ST', name: 'Mario Gomez', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Anatoliy Tymoshchuk', slotIndex: 3, nationality: 'Ukraine', clubAtTime: 'Bayern Munich', fact: 'A holding midfielder pressed into centre back with Badstuber suspended' },
      { name: 'Diego Contento', slotIndex: 4, nationality: 'Germany', clubAtTime: 'Bayern Munich' },
      { name: 'Mario Gomez', slotIndex: 10, nationality: 'Germany', clubAtTime: 'Bayern Munich' },
    ],
    source: 'Wikipedia 2012 UEFA Champions League final lineup table + Sky Sports team sheet (bay-munich-vs-chelsea/teams/259018), both read 2026-09-05, agree name for name.',
  },

  // 178. 2014 Champions League Final - the LOSING side, Atletico Madrid 1-4 Real Madrid (AET).
  {
    id: 'cl-2014-final-atletico',
    dateLabel: '2014 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2014-05-24',
    team: 'Atletico Madrid',
    ...
    venue: 'Estadio da Luz, Lisbon',
    formationLabel: '4-4-2',
    // Diego Costa started despite his hamstring and lasted nine minutes; Adrian replaced him.
    slots: [
      GK('Thibaut Courtois'),
      { position: 'RB', name: 'Juanfran', x: 84, y: 70 },
      { position: 'CB', name: 'Miranda', x: 62, y: 74 },
      { position: 'CB', name: 'Diego Godin', x: 38, y: 74 },
      { position: 'LB', name: 'Filipe Luis', x: 16, y: 70 },
      { position: 'RM', name: 'Raul Garcia', x: 82, y: 48 },
      { position: 'CM', name: 'Tiago', x: 60, y: 52 },
      { position: 'CM', name: 'Gabi', x: 40, y: 52 },
      { position: 'LM', name: 'Koke', x: 18, y: 48 },
      { position: 'ST', name: 'Diego Costa', x: 62, y: 18 },
      { position: 'ST', name: 'David Villa', x: 38, y: 18 },
    ],
    blankCandidates: [
      { name: 'Miranda', slotIndex: 2, nationality: 'Brazil', clubAtTime: 'Atletico Madrid' },
      { name: 'Raul Garcia', slotIndex: 5, nationality: 'Spain', clubAtTime: 'Atletico Madrid' },
      { name: 'Koke', slotIndex: 8, nationality: 'Spain', clubAtTime: 'Atletico Madrid' },
    ],
    source: 'Wikipedia 2014 UEFA Champions League final lineup table + Sky Sports team sheet (real-madrid-vs-atletico-madrid/teams/311491), both read 2026-09-05, agree name for name including Costa off at 9.',
  },

  // 179. 2010 Champions League Final - the LOSING side, Bayern Munich 0-2 Inter Milan.
  {
    id: 'cl-2010-final-bayern',
    dateLabel: '2010 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2010-05-22',
    team: 'Bayern Munich',
    ...
    blankCandidates: [
      ...
      { name: 'Martin Demichelis', slotIndex: 3, nationality: 'Argentina', clubAtTime: 'Bayern Munich' },
      { name: 'Ivica Olic', slotIndex: 10, nationality: 'Croatia', clubAtTime: 'Bayern Munich' },
    ],
    source: 'Wikipedia 2010 UEFA Champions League final lineup table + Sky Sports team sheet (bayern-munich-vs-inter-milan/teams/213137), both read 2026-09-05, agree name for name.',
  },

  // 180. 2007 Champions League Final - the LOSING side, Liverpool 1-2 AC Milan, the Istanbul rematch.
  {
    id: 'cl-2007-final-liverpool',
    dateLabel: '2007 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2007-05-23',
    team: 'Liverpool',
    ...
    slots: [
      ...
      { position: 'RB', name: 'Steve Finnan', x: 84, y: 70 },
      { position: 'CB', name: 'Jamie Carragher', x: 62, y: 74 },
      { position: 'CB', name: 'Daniel Agger', x: 38, y: 74 },
      { position: 'LB', name: 'John Arne Riise', x: 16, y: 70 },
      { position: 'CDM', name: 'Xabi Alonso', x: 62, y: 56 },
      { position: 'CDM', name: 'Javier Mascherano', x: 38, y: 56 },
      { position: 'RW', name: 'Jermaine Pennant', x: 80, y: 26 },
      { position: 'CAM', name: 'Steven Gerrard', x: 50, y: 40 },
      { position: 'LW', name: 'Boudewijn Zenden', x: 20, y: 26 },
      { position: 'ST', name: 'Dirk Kuyt', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Steve Finnan', slotIndex: 1, nationality: 'Ireland', clubAtTime: 'Liverpool' },
      { name: 'Jermaine Pennant', slotIndex: 7, nationality: 'England', clubAtTime: 'Liverpool' },
      { name: 'Boudewijn Zenden', slotIndex: 9, nationality: 'Netherlands', clubAtTime: 'Liverpool' },
    ],
    source: 'Wikipedia 2007 UEFA Champions League final lineup table + Sky Sports team sheet (ac-milan-vs-liverpool/teams/84687), both read 2026-09-05, agree name for name.',
  },

  // 181. 2006 Champions League Final - the LOSING side, Arsenal 1-2 Barcelona, ten men from the 18th minute.
  {
    id: 'cl-2006-final-arsenal',
    dateLabel: '2006 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2006-05-17',
    team: 'Arsenal',
    ...
    venue: 'Stade de France, Saint-Denis',
    formationLabel: '4-4-1-1',
    // Lehmann was sent off after 18 minutes and Pires was the man sacrificed for Almunia.
    slots: [
      GK('Jens Lehmann'),
      { position: 'RB', name: 'Emmanuel Eboue', x: 84, y: 70 },
      { position: 'CB', name: 'Kolo Touré', x: 62, y: 74 },
      { position: 'CB', name: 'Sol Campbell', x: 38, y: 74 },
      { position: 'LB', name: 'Ashley Cole', x: 16, y: 70 },
      { position: 'RM', name: 'Robert Pires', x: 82, y: 48 },
      { position: 'CM', name: 'Gilberto Silva', x: 60, y: 52 },
      { position: 'CM', name: 'Cesc Fabregas', x: 40, y: 52 },
      { position: 'LM', name: 'Alexander Hleb', x: 18, y: 48 },
      { position: 'CF', name: 'Freddie Ljungberg', x: 50, y: 30 },
      { position: 'ST', name: 'Thierry Henry', x: 50, y: 14 },
    ],
    blankCandidates: [
      { name: 'Emmanuel Eboue', slotIndex: 1, nationality: "Cote d'Ivoire", clubAtTime: 'Arsenal' },
      { name: 'Alexander Hleb', slotIndex: 8, nationality: 'Belarus', clubAtTime: 'Arsenal', aliases: ['Aleksandr Hleb'] },
      { name: 'Freddie Ljungberg', slotIndex: 9, nationality: 'Sweden', clubAtTime: 'Arsenal' },
    ],
    source: 'Wikipedia 2006 UEFA Champions League final lineup table + Sky Sports team sheet (barcelona-vs-arsenal/teams/72808), both read 2026-09-05, agree name for name. The market value table spells Hleb Aleksandr, hence the alias.',
  },

  // 182. 2008 Champions League Final - the LOSING side, Chelsea 1-1 Manchester United (lost 6-5 on penalties), Moscow.
  {
    id: 'cl-2008-final-chelsea',
    dateLabel: '2008 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2008-05-21',
    team: 'Chelsea',
    opponent: 'Manchester United',
    scoreLine: 'Manchester United 1-1 Chelsea (Manchester United won 6-5 on penalties)',
    venue: 'Luzhniki Stadium, Moscow',
    formationLabel: '4-3-3',
    // Essien played right back; Anelka, whose penalty lost it, came off the bench.
    slots: [
      GK('Petr Cech'),
      { position: 'RB', name: 'Michael Essien', x: 84, y: 70 },
      { position: 'CB', name: 'Ricardo Carvalho', x: 62, y: 74 },
      ...
      { position: 'LB', name: 'Ashley Cole', x: 16, y: 70 },
      { position: 'CDM', name: 'Claude Makelele', x: 50, y: 58 },
      { position: 'CM', name: 'Michael Ballack', x: 68, y: 50 },
      { position: 'CM', name: 'Frank Lampard', x: 32, y: 50 },
      { position: 'RW', name: 'Joe Cole', x: 80, y: 24 },
      { position: 'ST', name: 'Didier Drogba', x: 50, y: 18 },
      { position: 'LW', name: 'Florent Malouda', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Michael Essien', slotIndex: 1, nationality: 'Ghana', clubAtTime: 'Chelsea', fact: 'Played the final at right back' },
      { name: 'Joe Cole', slotIndex: 8, nationality: 'England', clubAtTime: 'Chelsea' },
      { name: 'Florent Malouda', slotIndex: 10, nationality: 'France', clubAtTime: 'Chelsea' },
    ],
    source: 'Wikipedia 2008 UEFA Champions League final lineup table + Sky Sports team sheet (manchester-united-vs-chelsea/teams/103061), both read 2026-09-05, agree name for name.',
  },

  // 183. 2004 Champions League Final - the LOSING side, Monaco 0-3 Porto.
  {
    id: 'cl-2004-final-monaco',
    dateLabel: '2004 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2004-05-26',
    team: 'Monaco',
    opponent: 'Porto',
    scoreLine: 'Monaco 0-3 Porto',
    venue: 'Arena AufSchalke, Gelsenkirchen',
    formationLabel: '4-3-3',
    // Flavio Roma kept goal: Barthez was cup-tied after playing the group stage for Manchester United. Giuly went off injured after 23 minutes.
    slots: [
      GK('Flavio Roma'),
      { position: 'RB', name: 'Hugo Ibarra', x: 84, y: 70 },
      { position: 'CB', name: 'Julien Rodriguez', x: 62, y: 74 },
      { position: 'CB', name: 'Gael Givet', x: 38, y: 74 },
      { position: 'LB', name: 'Patrice Evra', x: 16, y: 70 },
      { position: 'CDM', name: 'Akis Zikos', x: 50, y: 58 },
      { position: 'CM', name: 'Edouard Cisse', x: 68, y: 50 },
      { position: 'CM', name: 'Lucas Bernardi', x: 32, y: 50 },
      { position: 'RW', name: 'Ludovic Giuly', x: 80, y: 24 },
      { position: 'ST', name: 'Fernando Morientes', x: 50, y: 18 },
      { position: 'LW', name: 'Jerome Rothen', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Gael Givet', slotIndex: 3, nationality: 'France', clubAtTime: 'Monaco' },
      { name: 'Lucas Bernardi', slotIndex: 7, nationality: 'Argentina', clubAtTime: 'Monaco' },
      { name: 'Akis Zikos', slotIndex: 5, nationality: 'Greece', clubAtTime: 'Monaco' },
    ],
    source: 'Wikipedia 2004 UEFA Champions League final lineup table + ESPN lineup page (gameId 151504), both read 2026-09-05, agree name for name; Sky Sports carries a garbled squad list for this match and was not used.',
  },

  // 184. 2003 Champions League Final - the LOSING side, Juventus 0-0 AC Milan (lost 3-2 on penalties), Old Trafford.
  {
    id: 'cl-2003-final-juventus',
    dateLabel: '2003 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2003-05-28',
    team: 'Juventus',
    opponent: 'AC Milan',
    scoreLine: 'Juventus 0-0 AC Milan (AC Milan won 3-2 on penalties)',
    venue: 'Old Trafford, Manchester',
    formationLabel: '4-4-2',
    // Nedved was suspended, so Camoranesi started wide right; Tudor was injured before half time and Birindelli replaced him.
    slots: [
      GK('Gianluigi Buffon'),
      { position: 'RB', name: 'Lilian Thuram', x: 84, y: 70 },
      { position: 'CB', name: 'Ciro Ferrara', x: 62, y: 74 },
      { position: 'CB', name: 'Igor Tudor', x: 38, y: 74 },
      { position: 'LB', name: 'Paolo Montero', x: 16, y: 70 },
      { position: 'RM', name: 'Mauro Camoranesi', x: 82, y: 48 },
      { position: 'CM', name: 'Alessio Tacchinardi', x: 60, y: 52 },
      { position: 'CM', name: 'Edgar Davids', x: 40, y: 52 },
      { position: 'LM', name: 'Gianluca Zambrotta', x: 18, y: 48 },
      { position: 'ST', name: 'David Trezeguet', x: 62, y: 18 },
      { position: 'ST', name: 'Alessandro Del Piero', x: 38, y: 18 },
    ],
    // Pre-2004 match: Tudor, Tacchinardi and Camoranesi all carry 2004 Juventus rows in the value table.
    blankCandidates: [
      { name: 'Igor Tudor', slotIndex: 3, nationality: 'Croatia', clubAtTime: 'Juventus' },
      { name: 'Alessio Tacchinardi', slotIndex: 6, nationality: 'Italy', clubAtTime: 'Juventus' },
      { name: 'Mauro Camoranesi', slotIndex: 5, nationality: 'Italy', clubAtTime: 'Juventus' },
    ],
    source: 'Wikipedia 2003 UEFA Champions League final lineup table + ESPN lineup page (gameId 98095), both read 2026-09-05, agree name for name; Sky Sports lists ten of the eleven (no Davids) and was not relied on.',
  },

  // 185. 2002 Champions League Final - the LOSING side, Bayer Leverkusen 1-2 Real Madrid, the Zidane volley final.
  {
    id: 'cl-2002-final-leverkusen',
    dateLabel: '2002 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2002-05-15',
    team: 'Bayer Leverkusen',
    opponent: 'Real Madrid',
    scoreLine: 'Bayer Leverkusen 1-2 Real Madrid',
    venue: 'Hampden Park, Glasgow',
    formationLabel: '4-4-2',
    slots: [
      GK('Hans-Jorg Butt'),
      { position: 'RB', name: 'Zoltan Sebescen', x: 84, y: 70 },
      { position: 'CB', name: 'Boris Zivkovic', x: 62, y: 74 },
      { position: 'CB', name: 'Lucio', x: 38, y: 74 },
      { position: 'LB', name: 'Diego Placente', x: 16, y: 70 },
      { position: 'RM', name: 'Bernd Schneider', x: 82, y: 48 },
      { position: 'CM', name: 'Carsten Ramelow', x: 60, y: 52 },
      { position: 'CM', name: 'Michael Ballack', x: 40, y: 52 },
      { position: 'LM', name: 'Yildiray Basturk', x: 18, y: 48 },
      { position: 'ST', name: 'Oliver Neuville', x: 62, y: 18 },
      { position: 'ST', name: 'Thomas Brdaric', x: 38, y: 18 },
    ],
    // Pre-2004 match: Ramelow, Schneider and Neuville all carry 2004 Leverkusen rows in the value table.
    blankCandidates: [
      { name: 'Carsten Ramelow', slotIndex: 6, nationality: 'Germany', clubAtTime: 'Bayer Leverkusen' },
      { name: 'Bernd Schneider', slotIndex: 5, nationality: 'Germany', clubAtTime: 'Bayer Leverkusen', fact: 'His free kick was headed in by Lucio for the equaliser' },
      { name: 'Oliver Neuville', slotIndex: 9, nationality: 'Germany', clubAtTime: 'Bayer Leverkusen' },
    ],
    source: "Wikipedia 2002 UEFA Champions League final lineup table + kicker.de match page (leverkusen-gegen-real-madrid-2002-champions-league-567367, read through its search listing on 2026-09-05: Butt; Sebescen, Zivkovic, Lucio, Placente; Ramelow, Schneider, Ballack, Basturk; Neuville, Brdaric), name for name; Sky Sports' sheet for this match is incomplete and agrees on the seven it lists.",
  },

  // 186. 2001 Champions League Final - the LOSING side, Valencia 1-1 Bayern Munich (lost 5-4 on penalties), a second straight final defeat.
  {
    id: 'cl-2001-final-valencia',
    dateLabel: '2001 Champions League Final',
    competition: 'UEFA Champions League',
    matchDate: '2001-05-23',
    team: 'Valencia',
    opponent: 'Bayern Munich',
    scoreLine: 'Bayern Munich 1-1 Valencia (Bayern Munich won 5-4 on penalties)',
    venue: 'San Siro, Milan',
    formationLabel: '4-3-1-2',
    slots: [
      GK('Santiago Canizares'),
      { position: 'RB', name: 'Jocelyn Angloma', x: 84, y: 70 },
      { position: 'CB', name: 'Roberto Ayala', x: 62, y: 74 },
      { position: 'CB', name: 'Mauricio Pellegrino', x: 38, y: 74 },
      { position: 'LB', name: 'Amedeo Carboni', x: 16, y: 70 },
      { position: 'CDM', name: 'Ruben Baraja', x: 50, y: 58 },
      { position: 'CM', name: 'Gaizka Mendieta', x: 68, y: 48 },
      { position: 'CM', name: 'Kily Gonzalez', x: 32, y: 48 },
      { position: 'CAM', name: 'Pablo Aimar', x: 50, y: 34 },
      { position: 'ST', name: 'Juan Sanchez', x: 60, y: 18 },
      { position: 'ST', name: 'John Carew', x: 40, y: 18 },
    ],
    // Pre-2004 match: Pellegrino, Baraja and Carew all carry 2004 rows in the value table.
    blankCandidates: [
      { name: 'Mauricio Pellegrino', slotIndex: 3, nationality: 'Argentina', clubAtTime: 'Valencia', fact: 'Missed the decisive kick in the shootout' },
      { name: 'Ruben Baraja', slotIndex: 5, nationality: 'Spain', clubAtTime: 'Valencia' },
      { name: 'John Carew', slotIndex: 10, nationality: 'Norway', clubAtTime: 'Valencia' },
    ],
    source: 'Wikipedia 2001 UEFA Champions League final lineup table + Sky Sports team sheet (bayern-munich-vs-valencia/teams/119179), both read 2026-09-05, agree name for name.',
  },

  // 187. 2024 Euros Final - the LOSING side, England 1-2 Spain.
  {
    id: 'euro-2024-final-england',
    dateLabel: '2024 Euros Final',
    competition: 'UEFA European Championship',
    matchDate: '2024-07-14',
    team: 'England',
    ...
    venue: 'Olympiastadion, Berlin',
    formationLabel: '3-4-2-1',
    // Walker played the right of a back three with Saka and Shaw as the wing backs; Shaw made his first start of the tournament.
    slots: [
      GK('Jordan Pickford'),
      { position: 'CB', name: 'Kyle Walker', x: 68, y: 76 },
      { position: 'CB', name: 'John Stones', x: 50, y: 78 },
      { position: 'CB', name: 'Marc Guehi', x: 32, y: 76 },
      { position: 'RWB', name: 'Bukayo Saka', x: 86, y: 52 },
      { position: 'CM', name: 'Kobbie Mainoo', x: 62, y: 56 },
      { position: 'CM', name: 'Declan Rice', x: 38, y: 56 },
      { position: 'LWB', name: 'Luke Shaw', x: 14, y: 52 },
      { position: 'CAM', name: 'Phil Foden', x: 62, y: 32 },
      { position: 'CAM', name: 'Jude Bellingham', x: 38, y: 32 },
      { position: 'ST', name: 'Harry Kane', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Marc Guehi', slotIndex: 3, nationality: 'England', clubAtTime: 'Crystal Palace' },
      { name: 'Kobbie Mainoo', slotIndex: 5, nationality: 'England', clubAtTime: 'Manchester United' },
      { name: 'Luke Shaw', slotIndex: 7, nationality: 'England', clubAtTime: 'Manchester United', fact: 'His first start of the whole tournament' },
    ],
    source: 'Wikipedia UEFA Euro 2024 final lineup table + Sky Sports team sheet (spain-vs-england/teams/500431), both read 2026-09-05, agree name for name; the shape follows the positions Wikipedia lists (Walker at right centre back, Saka and Shaw wide).',
  },

  // 188. 2008 Euros Final - the LOSING side, Germany 0-1 Spain.
  {
    id: 'euro-2008-final-germany',
    dateLabel: '2008 Euros Final',
    competition: 'UEFA European Championship',
    matchDate: '2008-06-29',
    team: 'Germany',
    ...
    slots: [
      GK('Jens Lehmann'),
      { position: 'RB', name: 'Arne Friedrich', x: 84, y: 70 },
      { position: 'CB', name: 'Per Mertesacker', x: 62, y: 74 },
      { position: 'CB', name: 'Christoph Metzelder', x: 38, y: 74 },
      { position: 'LB', name: 'Philipp Lahm', x: 16, y: 70 },
      { position: 'CDM', name: 'Torsten Frings', x: 62, y: 56 },
      { position: 'CDM', name: 'Thomas Hitzlsperger', x: 38, y: 56 },
      { position: 'RW', name: 'Bastian Schweinsteiger', x: 80, y: 26 },
      { position: 'CAM', name: 'Michael Ballack', x: 50, y: 40 },
      { position: 'LW', name: 'Lukas Podolski', x: 20, y: 26 },
      { position: 'ST', name: 'Miroslav Klose', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Arne Friedrich', slotIndex: 1, nationality: 'Germany', clubAtTime: 'Hertha BSC' },
      { name: 'Christoph Metzelder', slotIndex: 3, nationality: 'Germany', clubAtTime: 'Real Madrid' },
      { name: 'Thomas Hitzlsperger', slotIndex: 6, nationality: 'Germany', clubAtTime: 'VfB Stuttgart' },
    ],
    source: 'Wikipedia UEFA Euro 2008 final lineup table + Sky Sports team sheet (germany-vs-spain/teams/103428), both read 2026-09-05, agree name for name.',
  },

  // 189. 2010 World Cup Semi-final - the LOSING side, Uruguay 2-3 Netherlands.
  {
    id: 'wc-2010-semi-uruguay',
    dateLabel: '2010 World Cup Semi-final',
    competition: 'FIFA World Cup',
    matchDate: '2010-07-06',
    team: 'Uruguay',
    opponent: 'Netherlands',
    ...
    venue: 'Cape Town Stadium, Cape Town',
    formationLabel: '4-4-2',
    // Suarez (suspended after the Ghana handball) and Lugano (injured) were both missing; Victorino and Caceres came in and Cavani partnered Forlan.
    slots: [
      GK('Fernando Muslera'),
      { position: 'RB', name: 'Maxi Pereira', x: 84, y: 70 },
      { position: 'CB', name: 'Diego Godin', x: 62, y: 74 },
      { position: 'CB', name: 'Mauricio Victorino', x: 38, y: 74 },
      { position: 'LB', name: 'Martin Caceres', x: 16, y: 70 },
      { position: 'RM', name: 'Diego Pérez', x: 82, y: 48 },
      { position: 'CM', name: 'Walter Gargano', x: 60, y: 52 },
      { position: 'CM', name: 'Egidio Arevalo Rios', x: 40, y: 52 },
      { position: 'LM', name: 'Alvaro Pereira', x: 18, y: 48 },
      { position: 'ST', name: 'Edinson Cavani', x: 62, y: 18 },
      { position: 'ST', name: 'Diego Forlan', x: 38, y: 18 },
    ],
    blankCandidates: [
      { name: 'Maxi Pereira', slotIndex: 1, nationality: 'Uruguay', clubAtTime: 'Benfica', fact: 'Scored in stoppage time to make it 3-2' },
      { name: 'Walter Gargano', slotIndex: 6, nationality: 'Uruguay', clubAtTime: 'Napoli' },
      { name: 'Diego Pérez', slotIndex: 5, nationality: 'Uruguay', clubAtTime: 'Monaco' },
    ],
    source: 'Wikipedia 2010 FIFA World Cup knockout stage, Uruguay v Netherlands section (wikitext API) + ESPN lineup page (gameId 264120), both read 2026-09-05, agree name for name including Victorino; Sky Sports lists ten of the eleven and was not relied on.',
  },

  // 190. 2010 World Cup Semi-final - Spain 1-0 Germany, Puyol's header.
  {
    id: 'wc-2010-semi-spain',
    dateLabel: '2010 World Cup Semi-final',
    competition: 'FIFA World Cup',
    matchDate: '2010-07-07',
    team: 'Spain',
    ...
    venue: 'Moses Mabhida Stadium, Durban',
    formationLabel: '4-3-3',
    // Pedro started ahead of Torres, the change that stuck for the final.
    slots: [
      GK('Iker Casillas'),
      { position: 'RB', name: 'Sergio Ramos', x: 84, y: 70 },
      { position: 'CB', name: 'Gerard Pique', x: 62, y: 74 },
      ...
      { position: 'CM', name: 'Xavi', x: 32, y: 50 },
      { position: 'RW', name: 'Andres Iniesta', x: 80, y: 24 },
      { position: 'CF', name: 'David Villa', x: 50, y: 18 },
      { position: 'LW', name: 'Pedro', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Joan Capdevila', slotIndex: 4, nationality: 'Spain', clubAtTime: 'Villarreal' },
      { name: 'Pedro', slotIndex: 10, nationality: 'Spain', clubAtTime: 'Barcelona', fact: 'Started ahead of Torres, and kept the place for the final' },
      { name: 'Xabi Alonso', slotIndex: 6, nationality: 'Spain', clubAtTime: 'Real Madrid' },
    ],
    source: 'Wikipedia 2010 FIFA World Cup knockout stage, Germany v Spain section (wikitext API) + Sky Sports team sheet (germany-vs-spain/teams/220751), both read 2026-09-05, agree name for name.',
  },

  // 191. 2018 World Cup Semi-final - France 1-0 Belgium, Umtiti's header.
  {
    id: 'wc-2018-semi-france',
    dateLabel: '2018 World Cup Semi-final',
    competition: 'FIFA World Cup',
    matchDate: '2018-07-10',
    team: 'France',
    opponent: 'Belgium',
    ...
    slots: [
      ...
      { position: 'CB', name: 'Samuel Umtiti', x: 38, y: 74 },
      { position: 'LB', name: 'Lucas Hernandez', x: 16, y: 70 },
      { position: 'CDM', name: "N'Golo Kante", x: 62, y: 56 },
      { position: 'CDM', name: 'Paul Pogba', x: 38, y: 56 },
      { position: 'RW', name: 'Kylian Mbappe', x: 80, y: 26 },
      { position: 'CAM', name: 'Antoine Griezmann', x: 50, y: 40 },
      { position: 'LW', name: 'Blaise Matuidi', x: 20, y: 26 },
      { position: 'ST', name: 'Olivier Giroud', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Benjamin Pavard', slotIndex: 1, nationality: 'France', clubAtTime: 'VfB Stuttgart' },
      { name: 'Samuel Umtiti', slotIndex: 3, nationality: 'France', clubAtTime: 'Barcelona', fact: 'Headed the only goal from a Griezmann corner six minutes into the second half' },
      { name: 'Blaise Matuidi', slotIndex: 9, nationality: 'France', clubAtTime: 'Juventus' },
    ],
    source: 'Wikipedia 2018 FIFA World Cup knockout stage, France v Belgium section (wikitext API) + Sky Sports team sheet (france-vs-belgium/teams/385229), both read 2026-09-05, agree name for name.',
  },

  // 192. 2018 World Cup Semi-final - Croatia 2-1 England (AET), their first final.
  {
    id: 'wc-2018-semi-croatia',
    dateLabel: '2018 World Cup Semi-final',
    competition: 'FIFA World Cup',
    matchDate: '2018-07-11',
    team: 'Croatia',
    ...
    blankCandidates: [
      { name: 'Sime Vrsaljko', slotIndex: 1, nationality: 'Croatia', clubAtTime: 'Atletico Madrid' },
      { name: 'Ivan Strinic', slotIndex: 4, nationality: 'Croatia', clubAtTime: 'Sampdoria' },
      { name: 'Ante Rebic', slotIndex: 8, nationality: 'Croatia', clubAtTime: 'Eintracht Frankfurt' },
    ],
    source: 'Wikipedia 2018 FIFA World Cup knockout stage, Croatia v England section (wikitext API) + Sky Sports team sheet (croatia-vs-england/teams/385230), both read 2026-09-05, agree name for name.',
  },

  // 193. 2022 World Cup Semi-final - France 2-0 Morocco.
  {
    id: 'wc-2022-semi-france',
    dateLabel: '2022 World Cup Semi-final',
    competition: 'FIFA World Cup',
    matchDate: '2022-12-14',
    team: 'France',
    opponent: 'Morocco',
    scoreLine: 'France 2-0 Morocco',
    venue: 'Al Bayt Stadium, Al Khor',
    formationLabel: '4-2-3-1',
    // Upamecano and Rabiot were ill, so Konate and Fofana came in.
    slots: [
      GK('Hugo Lloris'),
      { position: 'RB', name: 'Jules Kounde', x: 84, y: 70 },
      { position: 'CB', name: 'Raphael Varane', x: 62, y: 74 },
      ...
      { position: 'LB', name: 'Theo Hernandez', x: 16, y: 70 },
      { position: 'CDM', name: 'Aurelien Tchouameni', x: 62, y: 56 },
      { position: 'CDM', name: 'Youssouf Fofana', x: 38, y: 56 },
      { position: 'RW', name: 'Ousmane Dembele', x: 80, y: 26 },
      { position: 'CAM', name: 'Antoine Griezmann', x: 50, y: 40 },
      { position: 'LW', name: 'Kylian Mbappe', x: 20, y: 26 },
      { position: 'ST', name: 'Olivier Giroud', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Ibrahima Konate', slotIndex: 3, nationality: 'France', clubAtTime: 'Liverpool' },
      { name: 'Youssouf Fofana', slotIndex: 6, nationality: 'France', clubAtTime: 'Monaco' },
      { name: 'Jules Kounde', slotIndex: 1, nationality: 'France', clubAtTime: 'Barcelona' },
    ],
    source: 'Wikipedia 2022 FIFA World Cup knockout stage, France v Morocco section (wikitext API) + Sky Sports team sheet (france-vs-morocco/teams/463026), both read 2026-09-05, agree name for name.',
  },

  // 194. 2022 World Cup Quarter-final - the LOSING side, Portugal 0-1 Morocco. Ronaldo was on the bench.
  {
    id: 'wc-2022-qf-portugal',
    dateLabel: '2022 World Cup Quarter-final',
    competition: 'FIFA World Cup',
    matchDate: '2022-12-10',
    team: 'Portugal',
    opponent: 'Morocco',
    ...
    venue: 'Al Thumama Stadium, Doha',
    formationLabel: '4-3-3',
    // Ronaldo did not start (he came on at 51 with Cancelo); Goncalo Ramos led the line. A common misremembering trap.
    slots: [
      GK('Diogo Costa'),
      { position: 'RB', name: 'Diogo Dalot', x: 84, y: 70 },
      { position: 'CB', name: 'Pepe', x: 62, y: 74 },
      { position: 'CB', name: 'Ruben Dias', x: 38, y: 74 },
      { position: 'LB', name: 'Raphael Guerreiro', x: 16, y: 70 },
      { position: 'CDM', name: 'Ruben Neves', x: 50, y: 58 },
      { position: 'CM', name: 'Bernardo Silva', x: 68, y: 50 },
      { position: 'CM', name: 'Otavio', x: 32, y: 50 },
      { position: 'RW', name: 'Bruno Fernandes', x: 80, y: 24 },
      { position: 'ST', name: 'Goncalo Ramos', x: 50, y: 18 },
      { position: 'LW', name: 'Joao Felix', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Raphael Guerreiro', slotIndex: 4, nationality: 'Portugal', clubAtTime: 'Borussia Dortmund' },
      { name: 'Otavio', slotIndex: 7, nationality: 'Portugal', clubAtTime: 'Porto' },
      { name: 'Goncalo Ramos', slotIndex: 9, nationality: 'Portugal', clubAtTime: 'Benfica', fact: 'Kept his place up front after the hat-trick against Switzerland, with Ronaldo on the bench' },
    ],
    source: 'Wikipedia 2022 FIFA World Cup knockout stage, Morocco v Portugal section (wikitext API) + Sky Sports team sheet (morocco-vs-portugal/teams/463024), both read 2026-09-05, agree name for name and both have Ronaldo entering at 51.',
  },

  // 195. 2024 Euros Semi-final - Spain 2-1 France, Lamine Yamal's goal at 16.
  {
    id: 'euro-2024-semi-spain',
    dateLabel: '2024 Euros Semi-final',
    competition: 'UEFA European Championship',
    matchDate: '2024-07-09',
    team: 'Spain',
    opponent: 'France',
    scoreLine: 'Spain 2-1 France',
    venue: 'Allianz Arena, Munich',
    formationLabel: '4-2-3-1',
    // Carvajal and Le Normand were suspended and Pedri injured: Jesus Navas, Nacho and Dani Olmo all started.
    slots: [
      GK('Unai Simon'),
      { position: 'RB', name: 'Jesus Navas', x: 84, y: 70 },
      { position: 'CB', name: 'Nacho', x: 62, y: 74 },
      { position: 'CB', name: 'Aymeric Laporte', x: 38, y: 74 },
      { position: 'LB', name: 'Marc Cucurella', x: 16, y: 70 },
      { position: 'CDM', name: 'Rodri', x: 62, y: 56 },
      { position: 'CDM', name: 'Fabián Ruiz', x: 38, y: 56 },
      { position: 'RW', name: 'Lamine Yamal', x: 80, y: 26 },
      { position: 'CAM', name: 'Dani Olmo', x: 50, y: 40 },
      { position: 'LW', name: 'Nico Williams', x: 20, y: 26 },
      { position: 'ST', name: 'Alvaro Morata', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Jesus Navas', slotIndex: 1, nationality: 'Spain', clubAtTime: 'Sevilla', fact: 'Started at 38 with Carvajal suspended' },
      { name: 'Nacho', slotIndex: 2, nationality: 'Spain', clubAtTime: 'Real Madrid', aliases: ['Nacho Fernández'], fact: 'Started with Le Normand suspended' },
      { name: 'Marc Cucurella', slotIndex: 4, nationality: 'Spain', clubAtTime: 'Chelsea' },
    ],
    source: 'Wikipedia UEFA Euro 2024 knockout stage, Spain v France section (wikitext API) + Sky Sports team sheet (spain-vs-france/teams/500429), both read 2026-09-05, agree name for name including Navas, Nacho and Olmo.',
  },

  // 196. 2024 Euros Semi-final - England 2-1 Netherlands, Watkins at 90.
  {
    id: 'euro-2024-semi-england',
    dateLabel: '2024 Euros Semi-final',
    competition: 'UEFA European Championship',
    matchDate: '2024-07-10',
    team: 'England',
    opponent: 'Netherlands',
    scoreLine: 'Netherlands 1-2 England',
    venue: 'Westfalenstadion, Dortmund',
    formationLabel: '3-4-2-1',
    // Trippier started at left wing back with Shaw on the bench; Shaw replaced him at half time.
    slots: [
      GK('Jordan Pickford'),
      { position: 'CB', name: 'Kyle Walker', x: 68, y: 76 },
      { position: 'CB', name: 'John Stones', x: 50, y: 78 },
      ...
      { position: 'CM', name: 'Kobbie Mainoo', x: 62, y: 56 },
      { position: 'CM', name: 'Declan Rice', x: 38, y: 56 },
      { position: 'LWB', name: 'Kieran Trippier', x: 14, y: 52 },
      { position: 'CAM', name: 'Phil Foden', x: 62, y: 32 },
      { position: 'CAM', name: 'Jude Bellingham', x: 38, y: 32 },
      { position: 'ST', name: 'Harry Kane', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Kieran Trippier', slotIndex: 7, nationality: 'England', clubAtTime: 'Newcastle United', fact: 'Started at left wing back and made way for Shaw at half time' },
      { name: 'John Stones', slotIndex: 2, nationality: 'England', clubAtTime: 'Manchester City' },
      { name: 'Kobbie Mainoo', slotIndex: 5, nationality: 'England', clubAtTime: 'Manchester United' },
    ],
    source: 'Wikipedia UEFA Euro 2024 knockout stage, Netherlands v England section (wikitext API) + Sky Sports team sheet (netherlands-vs-england/teams/500430), both read 2026-09-05, agree name for name.',
  },

  // 197. 2021 Euros Semi-final - Italy 1-1 Spain (Italy won 4-2 on penalties).
  {
    id: 'euro-2021-semi-italy',
    dateLabel: '2021 Euros Semi-final',
    competition: 'UEFA European Championship',
    matchDate: '2021-07-06',
    team: 'Italy',
    opponent: 'Spain',
    scoreLine: 'Italy 1-1 Spain (Italy won 4-2 on penalties)',
    venue: 'Wembley Stadium, London',
    formationLabel: '4-3-3',
    // Emerson started at left back for the injured Spinazzola.
    slots: [
      GK('Gianluigi Donnarumma'),
      { position: 'RB', name: 'Giovanni Di Lorenzo', x: 84, y: 70 },
      { position: 'CB', name: 'Leonardo Bonucci', x: 62, y: 74 },
      ...
      { position: 'CM', name: 'Marco Verratti', x: 32, y: 50 },
      { position: 'RW', name: 'Federico Chiesa', x: 80, y: 24 },
      { position: 'ST', name: 'Ciro Immobile', x: 50, y: 18 },
      { position: 'LW', name: 'Lorenzo Insigne', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Giovanni Di Lorenzo', slotIndex: 1, nationality: 'Italy', clubAtTime: 'Napoli' },
      { name: 'Marco Verratti', slotIndex: 7, nationality: 'Italy', clubAtTime: 'Paris Saint-Germain' },
      { name: 'Ciro Immobile', slotIndex: 9, nationality: 'Italy', clubAtTime: 'Lazio' },
    ],
    source: 'Wikipedia UEFA Euro 2020 knockout stage, Italy v Spain section (wikitext API) + Sky Sports team sheet (italy-vs-spain/teams/421530), both read 2026-09-05, agree name for name.',
  },

  // 198. 2021 Euros Semi-final - the LOSING side, Denmark 1-2 England (AET).
  {
    id: 'euro-2021-semi-denmark',
    dateLabel: '2021 Euros Semi-final',
    competition: 'UEFA European Championship',
    matchDate: '2021-07-07',
    team: 'Denmark',
    opponent: 'England',
    scoreLine: 'England 2-1 Denmark (after extra time)',
    venue: 'Wembley Stadium, London',
    formationLabel: '3-4-3',
    slots: [
      GK('Kasper Schmeichel'),
      { position: 'CB', name: 'Andreas Christensen', x: 68, y: 76 },
      { position: 'CB', name: 'Simon Kjaer', x: 50, y: 78 },
      { position: 'CB', name: 'Jannik Vestergaard', x: 32, y: 76 },
      { position: 'RWB', name: 'Jens Stryger Larsen', x: 86, y: 52 },
      { position: 'CM', name: 'Pierre-Emile Hojbjerg', x: 62, y: 56 },
      { position: 'CM', name: 'Thomas Delaney', x: 38, y: 56 },
      { position: 'LWB', name: 'Joakim Maehle', x: 14, y: 52 },
      { position: 'RW', name: 'Martin Braithwaite', x: 68, y: 26 },
      { position: 'LW', name: 'Mikkel Damsgaard', x: 32, y: 26 },
      { position: 'ST', name: 'Kasper Dolberg', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Jannik Vestergaard', slotIndex: 3, nationality: 'Denmark', clubAtTime: 'Southampton' },
      { name: 'Joakim Maehle', slotIndex: 7, nationality: 'Denmark', clubAtTime: 'Atalanta' },
      { name: 'Mikkel Damsgaard', slotIndex: 9, nationality: 'Denmark', clubAtTime: 'Sampdoria', fact: 'Scored the free kick that put Denmark ahead at Wembley' },
    ],
    source: 'Wikipedia UEFA Euro 2020 knockout stage, England v Denmark section (wikitext API) + Sky Sports team sheet (england-vs-denmark/teams/421531), both read 2026-09-05, agree name for name.',
  },

  // 199. 2012 Euros Semi-final - Italy 2-1 Germany, Balotelli's two.
  {
    id: 'euro-2012-semi-italy',
    dateLabel: '2012 Euros Semi-final',
    competition: 'UEFA European Championship',
    matchDate: '2012-06-28',
    team: 'Italy',
    opponent: 'Germany',
    scoreLine: 'Germany 1-2 Italy',
    venue: 'National Stadium, Warsaw',
    formationLabel: '4-3-1-2',
    slots: [
      GK('Gianluigi Buffon'),
      { position: 'RB', name: 'Federico Balzaretti', x: 84, y: 70 },
      { position: 'CB', name: 'Andrea Barzagli', x: 62, y: 74 },
      { position: 'CB', name: 'Leonardo Bonucci', x: 38, y: 74 },
      { position: 'LB', name: 'Giorgio Chiellini', x: 16, y: 70 },
      { position: 'CDM', name: 'Andrea Pirlo', x: 50, y: 58 },
      { position: 'CM', name: 'Claudio Marchisio', x: 68, y: 48 },
      { position: 'CM', name: 'Daniele De Rossi', x: 32, y: 48 },
      { position: 'CAM', name: 'Riccardo Montolivo', x: 50, y: 34 },
      { position: 'ST', name: 'Mario Balotelli', x: 60, y: 18 },
      { position: 'ST', name: 'Antonio Cassano', x: 40, y: 18 },
    ],
    blankCandidates: [
      { name: 'Federico Balzaretti', slotIndex: 1, nationality: 'Italy', clubAtTime: 'Palermo' },
      { name: 'Riccardo Montolivo', slotIndex: 8, nationality: 'Italy', clubAtTime: 'Fiorentina', fact: 'His long pass set up the second Balotelli goal' },
      { name: 'Antonio Cassano', slotIndex: 10, nationality: 'Italy', clubAtTime: 'AC Milan' },
    ],
    source: 'Wikipedia UEFA Euro 2012 knockout stage, Germany v Italy section (wikitext API) + Sky Sports team sheet (germany-vs-italy/teams/264786), both read 2026-09-05, agree name for name.',
  },

  // 200. 2024 Copa America Final - the LOSING side, Colombia 0-1 Argentina (AET).
  {
    id: 'copa-2024-final-colombia',
    dateLabel: '2024 Copa America Final',
    competition: 'Copa America',
    matchDate: '2024-07-14',
    team: 'Colombia',
    opponent: 'Argentina',
    scoreLine: 'Argentina 1-0 Colombia (after extra time)',
    venue: 'Hard Rock Stadium, Miami Gardens',
    formationLabel: '4-3-3',
    slots: [
      GK('Camilo Vargas'),
      { position: 'RB', name: 'Santiago Arias', x: 84, y: 70 },
      { position: 'CB', name: 'Davinson Sanchez', x: 62, y: 74 },
      { position: 'CB', name: 'Carlos Cuesta', x: 38, y: 74 },
      { position: 'LB', name: 'Johan Mojica', x: 16, y: 70 },
      { position: 'CDM', name: 'Jefferson Lerma', x: 50, y: 58 },
      { position: 'CM', name: 'Richard Rios', x: 68, y: 50 },
      { position: 'CM', name: 'Jhon Arias', x: 32, y: 50 },
      { position: 'RW', name: 'James Rodriguez', x: 80, y: 24 },
      { position: 'ST', name: 'Jhon Cordoba', x: 50, y: 18 },
      { position: 'LW', name: 'Luis Diaz', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Davinson Sanchez', slotIndex: 2, nationality: 'Colombia', clubAtTime: 'Galatasaray' },
      { name: 'Carlos Cuesta', slotIndex: 3, nationality: 'Colombia', clubAtTime: 'Genk' },
      { name: 'Santiago Arias', slotIndex: 1, nationality: 'Colombia', clubAtTime: 'Bahia' },
    ],
    source: 'Wikipedia 2024 Copa America final lineup table + ESPN lineup page (gameId 703953), both read 2026-09-05, agree name for name; Sky Sports has no team sheet for this match.',
  },

  // 201. 2006 World Cup Semi-final - the LOSING side, Germany 0-2 Italy (AET), the hosts out in Dortmund.
  {
    id: 'wc-2006-semi-germany',
    dateLabel: '2006 World Cup Semi-final',
    competition: 'FIFA World Cup',
    matchDate: '2006-07-04',
    team: 'Germany',
    opponent: 'Italy',
    scoreLine: 'Germany 0-2 Italy (after extra time)',
    venue: 'Westfalenstadion, Dortmund',
    formationLabel: '4-4-2',
    // Frings was suspended after the Argentina brawl, so Kehl started beside Ballack; Schweinsteiger was on the bench.
    slots: [
      GK('Jens Lehmann'),
      { position: 'RB', name: 'Arne Friedrich', x: 84, y: 70 },
      { position: 'CB', name: 'Per Mertesacker', x: 62, y: 74 },
      ...
      { position: 'LB', name: 'Philipp Lahm', x: 16, y: 70 },
      { position: 'RM', name: 'Bernd Schneider', x: 82, y: 48 },
      { position: 'CM', name: 'Michael Ballack', x: 60, y: 52 },
      { position: 'CM', name: 'Sebastian Kehl', x: 40, y: 52 },
      { position: 'LM', name: 'Tim Borowski', x: 18, y: 48 },
      { position: 'ST', name: 'Miroslav Klose', x: 62, y: 18 },
      { position: 'ST', name: 'Lukas Podolski', x: 38, y: 18 },
    ],
    blankCandidates: [
      { name: 'Sebastian Kehl', slotIndex: 7, nationality: 'Germany', clubAtTime: 'Borussia Dortmund', fact: 'Started with Frings suspended' },
      { name: 'Tim Borowski', slotIndex: 8, nationality: 'Germany', clubAtTime: 'Werder Bremen' },
      { name: 'Per Mertesacker', slotIndex: 2, nationality: 'Germany', clubAtTime: 'Hannover 96' },
    ],
    source: 'Wikipedia 2006 FIFA World Cup knockout stage, Germany v Italy section (wikitext API) + Sky Sports team sheet (germany-vs-italy/teams/73195), both read 2026-09-05, agree name for name.',
  },

  // 202. 2024 Europa League Final - Atalanta 3-0 Bayer Leverkusen, Lookman's hat-trick ends the 51 game unbeaten run.
  {
    id: 'europa-2024-final-atalanta',
    dateLabel: '2024 Europa League Final',
    competition: 'UEFA Europa League',
    matchDate: '2024-05-22',
    team: 'Atalanta',
    opponent: 'Bayer Leverkusen',
    scoreLine: 'Atalanta 3-0 Bayer Leverkusen',
    venue: 'Aviva Stadium, Dublin',
    formationLabel: '3-4-2-1',
    // The Atalanta midfielder is the Brazilian Ederson, not the Manchester City goalkeeper; the string matches the file's one-spelling rule and he is never blanked.
    slots: [
      GK('Juan Musso'),
      { position: 'CB', name: 'Berat Djimsiti', x: 68, y: 76 },
      { position: 'CB', name: 'Isak Hien', x: 50, y: 78 },
      { position: 'CB', name: 'Sead Kolasinac', x: 32, y: 76 },
      { position: 'RWB', name: 'Davide Zappacosta', x: 86, y: 52 },
      { position: 'CM', name: 'Ederson', x: 62, y: 56 },
      { position: 'CM', name: 'Teun Koopmeiners', x: 38, y: 56 },
      { position: 'LWB', name: 'Matteo Ruggeri', x: 14, y: 52 },
      { position: 'CAM', name: 'Charles De Ketelaere', x: 62, y: 32 },
      { position: 'CAM', name: 'Ademola Lookman', x: 38, y: 32 },
      { position: 'ST', name: 'Gianluca Scamacca', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Berat Djimsiti', slotIndex: 1, nationality: 'Albania', clubAtTime: 'Atalanta' },
      { name: 'Isak Hien', slotIndex: 2, nationality: 'Sweden', clubAtTime: 'Atalanta' },
      { name: 'Davide Zappacosta', slotIndex: 4, nationality: 'Italy', clubAtTime: 'Atalanta' },
    ],
    source: 'Wikipedia 2024 UEFA Europa League final lineup table + Sky Sports team sheet (atalanta-vs-bayer-leverkusen/teams/504398), both read 2026-09-05, agree name for name.',
  },

  // 203. 2025 Club World Cup Final - Chelsea 3-0 Paris Saint-Germain, Palmer's two.
  {
    id: 'cwc-2025-final-chelsea',
    dateLabel: '2025 Club World Cup Final',
    competition: 'FIFA Club World Cup',
    matchDate: '2025-07-13',
    team: 'Chelsea',
    opponent: 'Paris Saint-Germain',
    scoreLine: 'Chelsea 3-0 Paris Saint-Germain',
    venue: 'MetLife Stadium, East Rutherford',
    formationLabel: '4-2-3-1',
    // Reece James started in midfield beside Caicedo, not at right back, where Gusto played.
    slots: [
      GK('Robert Sanchez'),
      { position: 'RB', name: 'Malo Gusto', x: 84, y: 70 },
      { position: 'CB', name: 'Trevoh Chalobah', x: 62, y: 74 },
      { position: 'CB', name: 'Levi Colwill', x: 38, y: 74 },
      { position: 'LB', name: 'Marc Cucurella', x: 16, y: 70 },
      { position: 'CDM', name: 'Reece James', x: 62, y: 56 },
      { position: 'CDM', name: 'Moises Caicedo', x: 38, y: 56 },
      { position: 'RW', name: 'Cole Palmer', x: 80, y: 26 },
      { position: 'CAM', name: 'Enzo Fernández', x: 50, y: 40 },
      { position: 'LW', name: 'Pedro Neto', x: 20, y: 26 },
      { position: 'ST', name: 'Joao Pedro', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Malo Gusto', slotIndex: 1, nationality: 'France', clubAtTime: 'Chelsea', fact: 'His cut-back made the first goal' },
      { name: 'Trevoh Chalobah', slotIndex: 2, nationality: 'England', clubAtTime: 'Chelsea' },
      { name: 'Pedro Neto', slotIndex: 9, nationality: 'Portugal', clubAtTime: 'Chelsea' },
    ],
    source: 'Wikipedia 2025 FIFA Club World Cup final lineup table + Sky Sports team sheet (chelsea-vs-paris-saint-germain/teams/526492), both read 2026-09-05, agree name for name.',
  },

  // 204. 2025 FA Cup Final - Crystal Palace 1-0 Manchester City, the club's first major trophy.
  {
    id: 'fa-2025-final-palace',
    dateLabel: '2025 FA Cup Final',
    competition: 'FA Cup',
    ...
    slots: [
      ...
      { position: 'CB', name: 'Maxence Lacroix', x: 50, y: 78 },
      { position: 'CB', name: 'Marc Guehi', x: 32, y: 76 },
      { position: 'RWB', name: 'Daniel Munoz', x: 86, y: 52 },
    ...
    blankCandidates: [
      { name: 'Chris Richards', slotIndex: 1, nationality: 'United States', clubAtTime: 'Crystal Palace' },
      { name: 'Maxence Lacroix', slotIndex: 2, nationality: 'France', clubAtTime: 'Crystal Palace' },
      { name: 'Daichi Kamada', slotIndex: 6, nationality: 'Japan', clubAtTime: 'Crystal Palace' },
    ],
    source: 'Wikipedia 2025 FA Cup final lineup table + Sky Sports team sheet (crystal-palace-vs-manchester-city/teams/529241), both read 2026-09-05, agree name for name.',
  },

  // 205. 2025 Europa League Final - Tottenham Hotspur 1-0 Manchester United, Bilbao.
  {
    id: 'europa-2025-final-spurs',
    dateLabel: '2025 Europa League Final',
    competition: 'UEFA Europa League',
    matchDate: '2025-05-21',
    team: 'Tottenham Hotspur',
    opponent: 'Manchester United',
    scoreLine: 'Tottenham Hotspur 1-0 Manchester United',
    venue: 'San Mames, Bilbao',
    formationLabel: '4-3-3',
    // Son started on the bench and came on at 67; Richarlison started on the left.
    slots: [
      GK('Guglielmo Vicario'),
      { position: 'RB', name: 'Pedro Porro', x: 84, y: 70 },
      { position: 'CB', name: 'Cristian Romero', x: 62, y: 74 },
      { position: 'CB', name: 'Micky van de Ven', x: 38, y: 74 },
      { position: 'LB', name: 'Destiny Udogie', x: 16, y: 70 },
      { position: 'CDM', name: 'Rodrigo Bentancur', x: 50, y: 58 },
      { position: 'CM', name: 'Pape Matar Sarr', x: 68, y: 50 },
      { position: 'CM', name: 'Yves Bissouma', x: 32, y: 50 },
      { position: 'RW', name: 'Brennan Johnson', x: 80, y: 24 },
      { position: 'ST', name: 'Dominic Solanke', x: 50, y: 18 },
      { position: 'LW', name: 'Richarlison', x: 20, y: 24 },
    ],
    blankCandidates: [
      { name: 'Micky van de Ven', slotIndex: 3, nationality: 'Netherlands', clubAtTime: 'Tottenham Hotspur' },
      { name: 'Brennan Johnson', slotIndex: 8, nationality: 'Wales', clubAtTime: 'Tottenham Hotspur', fact: 'Bundled in the only goal just before half time' },
      { name: 'Dominic Solanke', slotIndex: 9, nationality: 'England', clubAtTime: 'Tottenham Hotspur' },
    ],
    source: 'Wikipedia 2025 UEFA Europa League final lineup table + Sky Sports team sheet (tottenham-hotspur-vs-manchester-united/teams/528776), both read 2026-09-05, agree name for name.',
  },

  // 206. 2024-25 Premier League Title Clincher - Liverpool 5-1 Tottenham Hotspur, title number 20 sealed at Anfield.
  {
    id: 'epl-2025-liverpool-title',
    dateLabel: '2024-25 Premier League Title Clincher',
    competition: 'Premier League',
    matchDate: '2025-04-27',
    team: 'Liverpool',
    opponent: 'Tottenham Hotspur',
    scoreLine: 'Liverpool 5-1 Tottenham Hotspur',
    venue: 'Anfield, Liverpool',
    formationLabel: '4-2-3-1',
    // Luis Diaz played through the middle with Gakpo on the left.
    slots: [
      GK('Alisson'),
      { position: 'RB', name: 'Trent Alexander-Arnold', x: 84, y: 70 },
      { position: 'CB', name: 'Ibrahima Konate', x: 62, y: 74 },
      { position: 'CB', name: 'Virgil van Dijk', x: 38, y: 74 },
      { position: 'LB', name: 'Andrew Robertson', x: 16, y: 70 },
      { position: 'CDM', name: 'Ryan Gravenberch', x: 62, y: 56 },
      { position: 'CDM', name: 'Alexis Mac Allister', x: 38, y: 56 },
      { position: 'RW', name: 'Mohamed Salah', x: 80, y: 26 },
      { position: 'CAM', name: 'Dominik Szoboszlai', x: 50, y: 40 },
      { position: 'LW', name: 'Cody Gakpo', x: 20, y: 26 },
      { position: 'ST', name: 'Luis Diaz', x: 50, y: 16 },
    ],
    blankCandidates: [
      { name: 'Dominik Szoboszlai', slotIndex: 8, nationality: 'Hungary', clubAtTime: 'Liverpool' },
      { name: 'Cody Gakpo', slotIndex: 9, nationality: 'Netherlands', clubAtTime: 'Liverpool', fact: 'Scored the third' },
      { name: 'Ibrahima Konate', slotIndex: 2, nationality: 'France', clubAtTime: 'Liverpool' },
    ],
    source: 'Sky Sports team sheet (liverpool-vs-tottenham-hotspur/teams/506141) + lfchistory.net match page (SeasonArchive/Game/6026), both read 2026-09-05, agree on the Liverpool eleven name for name.',
  },

  // 207. The 6-1 Manchester Derby - Manchester City at Old Trafford, October 2011.
  {
    id: 'epl-2011-derby-city',
    dateLabel: '2011 Manchester Derby, the 6-1',
    competition: 'Premier League',
    matchDate: '2011-10-23',
    team: 'Manchester City',
    opponent: 'Manchester United',
    scoreLine: 'Manchester United 1-6 Manchester City',
    venue: 'Old Trafford, Manchester',
    formationLabel: '4-4-2',
    // Dzeko, who scored twice, came off the bench at 70; Balotelli and Aguero started.
    slots: [
      GK('Joe Hart'),
      { position: 'RB', name: 'Micah Richards', x: 84, y: 70 },
      { position: 'CB', name: 'Vincent Kompany', x: 62, y: 74 },
      { position: 'CB', name: 'Joleon Lescott', x: 38, y: 74 },
      { position: 'LB', name: 'Gaël Clichy', x: 16, y: 70 },
      { position: 'RM', name: 'James Milner', x: 82, y: 48 },
      { position: 'CM', name: 'Gareth Barry', x: 60, y: 52 },
      { position: 'CM', name: 'Yaya Toure', x: 40, y: 52 },
      { position: 'LM', name: 'David Silva', x: 18, y: 48 },
      { position: 'ST', name: 'Mario Balotelli', x: 62, y: 18 },
      { position: 'ST', name: 'Sergio Aguero', x: 38, y: 18 },
    ],
    blankCandidates: [
      { name: 'Micah Richards', slotIndex: 1, nationality: 'England', clubAtTime: 'Manchester City' },
      { name: 'Joleon Lescott', slotIndex: 3, nationality: 'England', clubAtTime: 'Manchester City' },
      { name: 'Gareth Barry', slotIndex: 6, nationality: 'England', clubAtTime: 'Manchester City' },
    ],
    source: 'Sky Sports team sheet (man-utd-vs-man-city/teams/245414) + ESPN lineup page (gameId 317936), both read 2026-09-05, agree name for name including Dzeko on at 70.',
  },
];
