            ...
            <div className="bg-gray-900 rounded-xl p-8 border border-red-600 max-w-lg mx-auto mb-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-2 max-w-xs mx-auto">
                    <input
                      ...
                      maxLength={30}
                      className="flex-1 min-w-0 bg-gray-800 border border-gray-600 rounded-md px-3 py-2 text-white placeholder:text-gray-400 focus:border-red-500"
                    />
                    <Button
              ...
              {leaderboard.length > 0 && (
                <div className="mb-6 text-left">
                  <h3 className="text-lg font-bold text-red-400 mb-3 text-center">🏆 All Time Top 10</h3>
