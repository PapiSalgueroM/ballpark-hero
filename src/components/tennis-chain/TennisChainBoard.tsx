                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-2 max-w-xs mx-auto">
                    <input
                      ...
                      maxLength={30}
                      className="flex-1 bg-gray-800 border border-gray-600 rounded-md px-3 py-2 text-white placeholder:text-gray-500 focus:outline-none focus:border-emerald-500"
                    />
                    <Button
