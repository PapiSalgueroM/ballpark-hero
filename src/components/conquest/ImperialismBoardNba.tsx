...
export default function ImperialismBoardNba() {
  ...
  const playRound = () => {
    ...
    for (const [h, a] of pairings) {
      games.push(resolveNbaGame(h, a, next));
    }
        ...
        <div className="rounded-2xl border border-gold/50 bg-card p-5 text-center">
          ...
          <div className="mt-4 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <ShareButtons
              ...
              score={`${score} pts`}
              customText={`NBA Imperialism 🗺️ ${nbaTeamLabel(champion)} took the whole map. My ${favorite ? nbaTeamLabel(favorite) : 'team'} finished with ${myStates} territories and I called ${predictionHits}/${predictionTotal} games. Score ${score}. douknowball.com/conquest-nba`}
            />
          </div>
        </div>
      )}
