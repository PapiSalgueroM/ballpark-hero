...
const ChainSuggestions = ({ query, previousPlayer, onSelect, visible }: ChainSuggestionsProps) => {
      ...
      try {
        const resp = await fetch(
          `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/nba-suggest-players`,
          {
            ...
            body: JSON.stringify({
              query,
              context: `Must have been a teammate of ${previousPlayer} on the same NBA team at some point`,
            }),
          }
        );
...
export default ChainSuggestions;
