...
export function LeagueTableCard({ rows, myClub, compact = false, title, preseason = false, onClubClick, footnote, zoneTop = 4 }: LeagueTableCardProps) {
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-3 md:p-4">
      ...
      <div className="grid grid-cols-[1rem_1fr_1rem_1rem_1rem_2.6rem_1.9rem_1.5rem] min-[375px]:grid-cols-[1.3rem_1fr_1.3rem_1.3rem_1.3rem_2.6rem_1.9rem_2rem] gap-x-0.5 min-[375px]:gap-x-1 text-[10px] text-muted-foreground uppercase tracking-wide pb-1 border-b border-border/60">
