...
export function NflConnectionsHowToPlay({ open, onOpenChange }: Props) {
  return (
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 text-sm text-foreground">
          <div className="space-y-2">
            ...
            <p>Find four groups of 5 NFL players who share a connection.</p>
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">Same franchise, same college, same draft slot, career milestones, and more.</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
