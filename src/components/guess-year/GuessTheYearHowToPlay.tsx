      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 text-sm text-foreground">
          <div className="space-y-2">
            ...
            <p>Figure out which year all the sports facts are from. Every clue in the round happened the same year.</p>
          </div>
          <div className="space-y-2">
            <p className="font-semibold text-primary">Gameplay</p>
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              <li>You start with 1 clue revealed</li>
              <li>Guess using the year picker</li>
              <li>Wrong guess reveals a new clue</li>
