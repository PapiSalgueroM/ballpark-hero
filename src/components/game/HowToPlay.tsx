        ...
        <div className="space-y-5 text-sm">
          ...
          <section>
            ...
            <ul className="space-y-1.5 text-muted-foreground">
              ...
              <li>🏟️ <span className="text-foreground">Club:</span> same league counts as yellow</li>
          ...
          <section>
            ...
            <ul className="space-y-1.5 text-muted-foreground">
              ...
              <li><span className="text-foreground font-semibold">Hard:</span> includes reserves and rotation players</li>
