...
import {
  ...
  nbaRelease, nbaSign, nbaTrade, EAST,
  NBA_ROUNDS,
...
export default function NbaFrontOfficeBoard() {
  ...
  const start = (abbr: string) => {
    ...
    setFeed([`Welcome to the ${label(abbr)} front office. The ${lg.season} season tips off now.`]);
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-2xl border border-gold/50 bg-card p-5 text-center">
          ...
          <p className="mt-2 font-display text-2xl font-black text-foreground">{label(champion)} win the {league.season} title</p>
