    ...
    <div className="relative flex gap-2 w-full max-w-md mx-auto items-start">
      <div className="flex-1">
        {/* Round 611: the search box offers the answer key's own display
            names (college_grid_players, with a school or a season span after
            a name two or more players share), so every name it offers is one
            the board can judge. It used to offer a hand typed list of 78
            players and let any typed name through. */}
        <PlayerAutocomplete
          value={input}
          onChange={setInput}
          onSelect={handleSelect}
          searchOptions={{ source: COLLEGE_GRID_PLAYER_SOURCE }}
