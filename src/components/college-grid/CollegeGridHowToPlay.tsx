      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <div className="pt-2 border-t border-border">
            ...
            <p className="text-xs">
              Each correct pick gets a rarity percentage: how many players picked the same name. Lower is better. Your final Rarity Score averages all 9 cells.
            </p>
          </div>
          <p>Players from 2000 to 2026. New grid every day at midnight.</p>
        </div>
      </DialogContent>
    </Dialog>
  );
