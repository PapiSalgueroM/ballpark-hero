/**
 * Round 503: a daily is recorded AS IT GOES, and the record replays the exact
 ...
 *       loop instead of a sequence. Found by the Round 503 caller sweep.
 *
 ...
 * at a copy carrying the pre 503 closure reads (see vitest.config.ts and
