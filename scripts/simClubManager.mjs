...
if (NATIONS.length !== 12) fail(`expected 12 nations, got ${NATIONS.length}`);
...
if (totalClubs !== 270) fail(`expected 270 playable clubs (186, plus 48 in Round 140, 18 in Round 142, 18 in Round 143), got ${totalClubs}`);
const ordering = [
