/**
 * Round 503 harness: a daily is recorded AS IT GOES, and the record replays
 * the exact run.
 *
 ...
 * a copy of the engine with the three pre 503 lines put back (the closure
...
/* The three lines Round 503 changed, and what stood there before. Verbatim,
...
console.log('Round 503: a daily is recorded as it goes, over the REAL hooks and real localStorage');
...
console.log('');
console.log('B) NEGATIVE CONTROL stale: the pre 503 closure reads put back, all three sections must go RED');
{
