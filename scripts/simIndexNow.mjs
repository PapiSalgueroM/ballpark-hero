...
const SITEMAP_FLOOR = 145; /* raised (R538, /mlb-gauntlet-draft; Round 526 shipped /search the same day but it is noindexed and not submitted, so it moves no floor); before that 144, raised R528 merge, main's 142 (R522 desktop, /nfl-playoff-format-history) plus the tablet lane's two (R522 tablet, /nba-gauntlet-draft and /nfl-gauntlet-draft); before that 141 (R520, /champions-league-format-history); before that 140 (R459, /soccer-conquest); before that 139 (R445, /buzzer-beater); before that 138 (R433, /free-kick); before that 137 (R369, /cbb-grid/archive); before that 136 (R368, /cbb-grid); before that 135 (R358, the MLB and NHL grid archives); before that 133 (R352, /nba-stat-line, on top of R354's /nba-grid/archive: both lanes added one page and both wrote 132, so the true floor with both landed is 133; before them 131 (R328, /gauntlet-draft); before that 130 (R325, /search-and-discard); before that 129 (R323, /sports-bingo), 128 (R314, Overrated or Underrated and Tier List retired at the owner's call), 130 (R306, /accessibility), 129 (R293, /idle-arena and /face-off), 127 (R270, the five sport hubs) */
