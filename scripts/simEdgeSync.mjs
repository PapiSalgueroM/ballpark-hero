...
console.log('3) the unverified list is a ratchet');
{
  /* Measured 2026-09-06: 25 functions had never been checked against what is
     actually deployed, and Rounds 486 and 487 confirmed nba-chain-validate and tennis-chain-validate, leaving 23. The number may fall and must never rise, because the
