...
say((await block.locator('h2').innerText()).includes('Play Next'), 'the block introduces itself');
const tiles = block.locator('[data-play-next-game]');
...
await page.waitForTimeout(1200);
const smallTiles = page.locator('[data-related-games] [data-play-next-game]');
