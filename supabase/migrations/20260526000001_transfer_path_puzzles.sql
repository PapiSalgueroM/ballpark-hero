-- Migration: transfer_path_puzzles table + seed
-- Apply manually in Supabase SQL Editor
-- Schema first, seed follows in the same execution

-- ============================================================
-- transfer_path_puzzles
-- ============================================================
CREATE TABLE public.transfer_path_puzzles (
...
CREATE POLICY "Anyone can read transfer path puzzles"
  ON public.transfer_path_puzzles FOR SELECT
  TO public USING (true);

CREATE INDEX transfer_path_puzzles_puzzle_id_idx    ON public.transfer_path_puzzles (puzzle_id);
CREATE INDEX transfer_path_puzzles_sort_order_idx   ON public.transfer_path_puzzles (sort_order);

-- ============================================================
-- Seed — 20 puzzles (sort_order 0-indexed)
-- ============================================================
INSERT INTO public.transfer_path_puzzles
  (puzzle_id, player_a, player_b, min_steps, hint, sort_order)
VALUES
