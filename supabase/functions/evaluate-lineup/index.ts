...
Your job: Evaluate how good this team would realistically perform over a full season. Consider:
- Player quality and reputation
...
IMPORTANT: If any player names seem completely made up or don't exist in football, be harsh and call it out. Also check if the player has actually played for the club/nation they were assigned.
